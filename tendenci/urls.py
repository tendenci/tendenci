...
urlpatterns += patterns('',
    ...
    (r'^memberships/', include('tendenci.addons.memberships.urls')),
    (r'^corporatememberships/', include('tendenci.addons.corporate_memberships.urls')),
    ...
    (r'^photos/', include('tendenci.addons.photos.urls')),
    (r'^forms/', include('tendenci.contrib.forms_builder.forms.urls')),
    (r'^events/', include('tendenci.addons.events.urls')),
    ...
    (r'^search/', include('tendenci.contrib.search.urls')),
    ...
    (r'^resumes/', include('tendenci.addons.resumes.urls')),
