...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('jobs_job', (
            ...
            ('percent_travel', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_creator', null=True, to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_owner', null=True, to=orm['auth.User'])),
    ...
    models = {
        ...
        'jobs.job': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'job_creator'", 'null': 'True', 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'job_owner'", 'null': 'True', 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
