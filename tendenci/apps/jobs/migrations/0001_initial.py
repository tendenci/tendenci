    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(max_length=50, blank=True, help_text='i.e. entry-level, mid-level, senior or executive level, etc')),
                ('period', models.CharField(max_length=50, blank=True, help_text='i.e. seasonal, part-time, full-time, etc')),
