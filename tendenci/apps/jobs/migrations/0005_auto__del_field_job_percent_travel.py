...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Job.percent_travel'
        db.delete_column('jobs_job', 'percent_travel')


    def backwards(self, orm):
        
        # Adding field 'Job.percent_travel'
        db.add_column('jobs_job', 'percent_travel', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 19, 2, 12, 46, 791228)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 19, 2, 12, 46, 791078)'}),
