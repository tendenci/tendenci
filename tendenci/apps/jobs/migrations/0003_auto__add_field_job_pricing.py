...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.pricing'
        db.add_column('jobs_job', 'pricing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobs.JobPricing'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.pricing'
        db.delete_column('jobs_job', 'pricing_id')
