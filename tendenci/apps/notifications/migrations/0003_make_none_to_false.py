...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.NoticeSetting.objects.exclude(send=True).update(send=False)

        orm.Notice.objects.exclude(unseen=True).update(unseen=False)
        orm.Notice.objects.exclude(archived=True).update(archived=False)
        orm.Notice.objects.exclude(on_site=True).update(on_site=False)
