...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('regions_region', (
            ...
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='regions_region_entity', null=True, blank=True, to=orm['entities.Entity'])),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='regions_region_creator', null=True, to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='regions_region_owner', null=True, to=orm['auth.User'])),
            ...
            ('region_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('region_code', self.gf('django.db.models.fields.CharField')(max_length=200)),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 24, 10, 50, 57, 614863)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 24, 10, 50, 57, 614756)'}),
