...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for nav in orm.NavItem.objects.all():
            nav.position = nav.ordering
            nav.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 15, 38, 17, 252478)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 15, 38, 17, 252347)'}),
