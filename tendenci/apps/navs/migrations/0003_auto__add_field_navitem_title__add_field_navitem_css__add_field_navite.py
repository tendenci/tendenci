...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NavItem.title'
        db.add_column('navs_navitem', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'NavItem.css'
        db.add_column('navs_navitem', 'css', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'NavItem.ordering'
        db.add_column('navs_navitem', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'NavItem.level'
        db.add_column('navs_navitem', 'level', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NavItem.title'
        db.delete_column('navs_navitem', 'title')

        # Deleting field 'NavItem.css'
        db.delete_column('navs_navitem', 'css')

        # Deleting field 'NavItem.ordering'
        db.delete_column('navs_navitem', 'ordering')

        # Deleting field 'NavItem.level'
        db.delete_column('navs_navitem', 'level')
