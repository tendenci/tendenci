...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NavItem.menu'
        db.delete_column('navs_navitem', 'menu_id')

        # Deleting field 'NavItem.link'
        db.delete_column('navs_navitem', 'link')

        # Adding field 'NavItem.nav'
        db.add_column('navs_navitem', 'nav', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['navs.Nav']), keep_default=False)

        # Adding field 'NavItem.page'
        db.add_column('navs_navitem', 'page', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pages.Page']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'NavItem.menu'
        db.add_column('navs_navitem', 'menu', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['navs.Nav']), keep_default=False)

        # Adding field 'NavItem.link'
        db.add_column('navs_navitem', 'link', self.gf('django.db.models.fields.URLField')(default='www.tendenci.com', max_length=200), keep_default=False)

        # Deleting field 'NavItem.nav'
        db.delete_column('navs_navitem', 'nav_id')

        # Deleting field 'NavItem.page'
        db.delete_column('navs_navitem', 'page_id')
    ...
    models = {
        ...
        'pages.page': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'page_owner'", 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
