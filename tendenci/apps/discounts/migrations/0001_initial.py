...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('discounts_discount', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='discounts_discount_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='discounts_discount_owner', to=orm['auth.User'])),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 24, 9, 736856)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 24, 9, 736769)'}),
        ...
        'discounts.discount': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'discounts_discount_creator'", 'to': "orm['auth.User']"}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'discounts_discount_owner'", 'to': "orm['auth.User']"}),
