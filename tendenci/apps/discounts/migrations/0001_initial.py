...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('discounts_discount', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='discount_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='discount_owner', to=orm['auth.User'])),
            ...
            ('discount_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ...
        # Adding model 'DiscountUse'
        db.create_table('discounts_discountuse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoices.Invoice'])),
            ('discount', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discounts.Discount'])),
            ('create_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('discounts', ['DiscountUse'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DiscountUse'
        db.delete_table('discounts_discountuse')
    ...
    models = {
        ...
        'discounts.discount': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'discount_creator'", 'to': "orm['auth.User']"}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'discount_owner'", 'to': "orm['auth.User']"}),
