...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'discounts_discount', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
        ...
        # Changing field 'Discount.entity'
        db.alter_column(u'discounts_discount', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['entities.Entity'], null=True))
        ...
        db.alter_column(u'discounts_discount', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Discount.creator'
        db.alter_column(u'discounts_discount', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Discount.allow_member_view'
        db.alter_column(u'discounts_discount', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Discount.entity'
        db.alter_column(u'discounts_discount', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['entities.Entity']))

        # Changing field 'Discount.allow_member_edit'
        db.alter_column(u'discounts_discount', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Discount.owner'
        db.alter_column(u'discounts_discount', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
