...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Discount.allow_anonymous_edit'
        db.delete_column('discounts_discount', 'allow_anonymous_edit')

        # Adding field 'Discount.entity'
        db.add_column('discounts_discount', 'entity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='discounts_discount_entity', null=True, blank=True, to=orm['entities.Entity']), keep_default=False)

        # Changing field 'Discount.creator'
        db.alter_column('discounts_discount', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Discount.owner'
        db.alter_column('discounts_discount', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))


    def backwards(self, orm):
        
        # Adding field 'Discount.allow_anonymous_edit'
        db.add_column('discounts_discount', 'allow_anonymous_edit', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Discount.entity'
        db.delete_column('discounts_discount', 'entity_id')

        # Changing field 'Discount.creator'
        db.alter_column('discounts_discount', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Discount.owner'
        db.alter_column('discounts_discount', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 16, 11, 42, 601986)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 16, 11, 42, 601896)'}),
