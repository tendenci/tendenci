...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Discount.status'
        db.alter_column(u'discounts_discount', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Discount.never_expires'
        db.alter_column(u'discounts_discount', 'never_expires', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Discount.allow_user_edit'
        db.alter_column(u'discounts_discount', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Discount.allow_user_view'
        db.alter_column(u'discounts_discount', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Discount.allow_member_view'
        db.alter_column(u'discounts_discount', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Discount.allow_member_edit'
        db.alter_column(u'discounts_discount', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Discount.allow_anonymous_view'
        db.alter_column(u'discounts_discount', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Discount.status'
        db.alter_column(u'discounts_discount', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Discount.never_expires'
        db.alter_column(u'discounts_discount', 'never_expires', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Discount.allow_user_edit'
        db.alter_column(u'discounts_discount', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Discount.allow_user_view'
        db.alter_column(u'discounts_discount', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Discount.allow_member_view'
        db.alter_column(u'discounts_discount', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Discount.allow_member_edit'
        db.alter_column(u'discounts_discount', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Discount.allow_anonymous_view'
        db.alter_column(u'discounts_discount', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        u'discounts.discount': {
            ...
            'apps': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['contenttypes.ContentType']", 'symmetrical': 'False'}),
            'cap': ('django.db.models.fields.IntegerField', [], {}),
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'discounts_discount_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'discounts_discount_entity'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['entities.Entity']", 'blank': 'True', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'never_expires': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'discounts_discount_owner'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
        ...
        u'discounts.discountuse': {
            'Meta': {'object_name': 'DiscountUse'},
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'discount': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['discounts.Discount']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
