...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form.intro_name'
        db.add_column('forms_form', 'intro_name',
                      self.gf('django.db.models.fields.CharField')(default='Intro', max_length=50),
                      keep_default=False)

        # Adding field 'Form.fields_name'
        db.add_column('forms_form', 'fields_name',
                      self.gf('django.db.models.fields.CharField')(default='Fields', max_length=50),
                      keep_default=False)

        # Adding field 'Form.pricing_name'
        db.add_column('forms_form', 'pricing_name',
                      self.gf('django.db.models.fields.CharField')(default='Pricings', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form.intro_name'
        db.delete_column('forms_form', 'intro_name')

        # Deleting field 'Form.fields_name'
        db.delete_column('forms_form', 'fields_name')

        # Deleting field 'Form.pricing_name'
        db.delete_column('forms_form', 'pricing_name')
    ...
    models = {
        ...
        'forms.form': {
            ...
            'fields_name': ('django.db.models.fields.CharField', [], {'default': "'Fields'", 'max_length': '50'}),
            ...
            'intro_name': ('django.db.models.fields.CharField', [], {'default': "'Intro'", 'max_length': '50'}),
            ...
            'pricing_name': ('django.db.models.fields.CharField', [], {'default': "'Pricing'", 'max_length': '50'}),
