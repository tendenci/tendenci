...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form.intro_position'
        db.add_column('forms_form', 'intro_position',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Form.fields_position'
        db.add_column('forms_form', 'fields_position',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Form.pricing_position'
        db.add_column('forms_form', 'pricing_position',
                      self.gf('django.db.models.fields.IntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form.intro_position'
        db.delete_column('forms_form', 'intro_position')

        # Deleting field 'Form.fields_position'
        db.delete_column('forms_form', 'fields_position')

        # Deleting field 'Form.pricing_position'
        db.delete_column('forms_form', 'pricing_position')
