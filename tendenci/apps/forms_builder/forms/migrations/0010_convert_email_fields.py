...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for field in orm.Field.objects.all():
            if field.field_type == "EmailField":
                field.field_type = "EmailVerificationField"
                field.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 9, 12, 16, 38, 908407)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 9, 12, 16, 38, 908304)'}),
