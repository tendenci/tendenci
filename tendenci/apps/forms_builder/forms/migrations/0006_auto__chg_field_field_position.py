...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Field.position'
        db.alter_column('forms_field', 'position', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):

        # Changing field 'Field.position'
        db.alter_column('forms_field', 'position', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 13, 7, 49, 37, 644202)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 13, 7, 49, 37, 644102)'}),
