...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Form.custom_payment'
        db.add_column('forms_form', 'custom_payment', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Form.custom_payment'
        db.delete_column('forms_form', 'custom_payment')
