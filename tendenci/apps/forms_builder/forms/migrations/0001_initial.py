    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_type', models.CharField(max_length=64, verbose_name='Type', choices=[(b'CharField', 'Text'), (b'CharField/django.forms.Textarea', 'Paragraph Text'), (b'BooleanField', 'Checkbox'), (b'ChoiceField/django.forms.RadioSelect', 'Single-select - Radio Button'), (b'ChoiceField', 'Single-select - From a List'), (b'MultipleChoiceField/django.forms.CheckboxSelectMultiple', 'Multi-select - Checkboxes'), (b'MultipleChoiceField', 'Multi-select - From a List'), (b'EmailVerificationField', 'Email'), (b'CountryField', 'Countries'), (b'StateProvinceField', 'States/Provinces'), (b'FileField', 'File upload'), (b'DateField/django.forms.extras.SelectDateWidget', 'Date - Select'), (b'DateField/django.forms.DateInput', 'Date - Text Input'), (b'DateTimeField', 'Date/time'), (b'CharField/tendenci.apps.forms_builder.forms.widgets.Description', 'Description'), (b'CharField/tendenci.apps.forms_builder.forms.widgets.Header', 'Section Heading')])),
                ('field_function', models.CharField(blank=True, max_length=64, null=True, verbose_name='Special Functionality', choices=[(b'GroupSubscription', 'Subscribe to Group'), (b'GroupSubscriptionAuto', 'Subscribe to Group'), (b'EmailFirstName', 'First Name'), (b'EmailLastName', 'Last Name'), (b'EmailFullName', 'Full Name'), (b'EmailPhoneNumber', 'Phone Number'), (b'Recipients', 'Email to Recipients')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_text', models.TextField(default=b'', help_text='If Send email is checked, this is the text that will be sent in an email to the person submitting the form.', max_length=2000, verbose_name='Email Text to Submitter', blank=True)),
                ('subject_template', models.CharField(default=b'[title] - [first name]  [last name] - [phone]', max_length=200, blank=True, help_text='Options include [title] for form title, and\n                        name of form fields inside brackets [ ]. E.x. [first name] or\n                        [email address]', null=True, verbose_name='Template for email subject ')),
                ...
                ('email_from', models.EmailField(help_text='The address the replies to the email will be sent to', max_length=254, verbose_name='Reply-To address', blank=True)),
                ('email_copies', models.CharField(help_text='One or more email addresses, separated by commas', max_length=2000, verbose_name='Send copies to', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry_path', models.CharField(default=b'', max_length=200, blank=True)),
