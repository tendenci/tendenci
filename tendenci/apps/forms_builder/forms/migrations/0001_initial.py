    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completion_url', models.CharField(help_text='Optionally, redirect to this page after form completion. Absolute URLS should begin with https://. Relative URLs should begin with a forward slash (/).', max_length=1000, null=True, verbose_name='Completion URL', blank=True)),
