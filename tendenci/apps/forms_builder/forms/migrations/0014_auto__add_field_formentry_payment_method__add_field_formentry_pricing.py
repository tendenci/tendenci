...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormEntry.payment_method'
        db.add_column('forms_formentry', 'payment_method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.PaymentMethod'], null=True), keep_default=False)

        # Adding field 'FormEntry.pricing'
        db.add_column('forms_formentry', 'pricing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forms.Pricing'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FormEntry.payment_method'
        db.delete_column('forms_formentry', 'payment_method_id')

        # Deleting field 'FormEntry.pricing'
        db.delete_column('forms_formentry', 'pricing_id')
