...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Form.completion_url'
        db.add_column('forms_form', 'completion_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Form.completion_url'
        db.delete_column('forms_form', 'completion_url')
