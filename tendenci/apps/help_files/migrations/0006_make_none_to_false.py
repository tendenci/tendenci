...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.HelpFile.objects.exclude(is_faq=True).update(is_faq=False)
        orm.HelpFile.objects.exclude(is_featured=True).update(is_featured=False)
        orm.HelpFile.objects.exclude(is_video=True).update(is_video=False)
        orm.HelpFile.objects.exclude(syndicate=True).update(syndicate=False)
        orm.HelpFile.objects.exclude(allow_anonymous_view=True).update(allow_anonymous_view=False)
        orm.HelpFile.objects.exclude(allow_user_view=True).update(allow_user_view=False)
        orm.HelpFile.objects.exclude(allow_member_view=True).update(allow_member_view=False)
        orm.HelpFile.objects.exclude(allow_user_edit=True).update(allow_user_edit=False)
        orm.HelpFile.objects.exclude(allow_member_edit=True).update(allow_member_edit=False)
        orm.HelpFile.objects.exclude(status=True).update(status=False)
