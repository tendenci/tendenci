...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Page.allow_anonymous_edit'
        db.delete_column('pages_page', 'allow_anonymous_edit')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Page.allow_anonymous_edit'
        db.add_column('pages_page', 'allow_anonymous_edit', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Page.creator'
        db.alter_column('pages_page', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Page.owner'
        db.alter_column('pages_page', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 16, 0, 25, 447903)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 16, 0, 25, 447810)'}),
