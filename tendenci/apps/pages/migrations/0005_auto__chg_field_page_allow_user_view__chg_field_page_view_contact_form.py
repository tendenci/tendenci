...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Page.allow_user_view'
        db.alter_column(u'pages_page', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Page.view_contact_form'
        db.alter_column(u'pages_page', 'view_contact_form', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Page.allow_anonymous_view'
        db.alter_column(u'pages_page', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Page.status'
        db.alter_column(u'pages_page', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Page.syndicate'
        db.alter_column(u'pages_page', 'syndicate', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Page.allow_user_edit'
        db.alter_column(u'pages_page', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Page.allow_member_view'
        db.alter_column(u'pages_page', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Page.allow_member_edit'
        db.alter_column(u'pages_page', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Page.allow_user_view'
        db.alter_column(u'pages_page', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Page.view_contact_form'
        db.alter_column(u'pages_page', 'view_contact_form', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Page.allow_anonymous_view'
        db.alter_column(u'pages_page', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Page.status'
        db.alter_column(u'pages_page', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Page.syndicate'
        db.alter_column(u'pages_page', 'syndicate', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Page.allow_user_edit'
        db.alter_column(u'pages_page', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Page.allow_member_view'
        db.alter_column(u'pages_page', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Page.allow_member_edit'
        db.alter_column(u'pages_page', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'pages.page': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['user_groups.Group']", 'null': 'True'}),
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
