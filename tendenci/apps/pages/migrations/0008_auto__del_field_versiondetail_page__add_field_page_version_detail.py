...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'VersionDetail.page'
        db.delete_column('pages_versiondetail', 'page_id')

        # Adding field 'Page.version_detail'
        db.add_column('pages_page', 'version_detail', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pages.VersionDetail'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'VersionDetail.page'
        db.add_column('pages_versiondetail', 'page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pages.Page'], null=True), keep_default=False)

        # Deleting field 'Page.version_detail'
        db.delete_column('pages_page', 'version_detail_id')
    ...
    models = {
        ...
        'pages.page': {
            ...
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'slug': ('base.fields.SlugField', [], {'max_length': '100', 'db_index': 'True'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
            ...
            'update_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'version_detail': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pages.VersionDetail']", 'null': 'True'}),
            'view_contact_form': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'pages.versiondetail': {
            'Meta': {'object_name': 'VersionDetail'},
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
