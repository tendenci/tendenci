...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'VersionDetail'
        db.delete_table('pages_versiondetail')
    ...
    def backwards(self, orm):
        ...
        # Adding model 'VersionDetail'
        db.create_table('pages_versiondetail', (
        ...
        db.send_create_signal('pages', ['VersionDetail'])
