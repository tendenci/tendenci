...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'VersionDetail.guid'
        db.delete_column('pages_versiondetail', 'guid')


    def backwards(self, orm):
        
        # Adding field 'VersionDetail.guid'
        db.add_column('pages_versiondetail', 'guid', self.gf('django.db.models.fields.CharField')(default='1', max_length=40), keep_default=False)
