...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('subscribers_groupsubscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_groups.Group'])),
            ('subscriber', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriptions', null=True, to=orm['forms.FormEntry'])),
        ...
        db.send_create_signal('subscribers', ['GroupSubscription'])

        # Adding unique constraint on 'GroupSubscription', fields ['group', 'subscriber']
        db.create_unique('subscribers_groupsubscription', ['group_id', 'subscriber_id'])

        # Adding model 'SubscriberData'
        db.create_table('subscribers_subscriberdata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscription', self.gf('django.db.models.fields.related.ForeignKey')(related_name='data', to=orm['subscribers.GroupSubscription'])),
            ('field_label', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ))
        db.send_create_signal('subscribers', ['SubscriberData'])

        # Adding unique constraint on 'SubscriberData', fields ['subscription', 'field_label']
        db.create_unique('subscribers_subscriberdata', ['subscription_id', 'field_label'])


    def backwards(self, orm):

        # Removing unique constraint on 'SubscriberData', fields ['subscription', 'field_label']
        db.delete_unique('subscribers_subscriberdata', ['subscription_id', 'field_label'])

        # Removing unique constraint on 'GroupSubscription', fields ['group', 'subscriber']
        db.delete_unique('subscribers_groupsubscription', ['group_id', 'subscriber_id'])

        # Deleting model 'GroupSubscription'
        db.delete_table('subscribers_groupsubscription')

        # Deleting model 'SubscriberData'
        db.delete_table('subscribers_subscriberdata')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 14, 9, 46, 8, 911266)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 14, 9, 46, 8, 911138)'}),
        ...
        'subscribers.groupsubscription': {
            'Meta': {'unique_together': "(('group', 'subscriber'),)", 'object_name': 'GroupSubscription'},
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subscriber': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subscriptions'", 'null': 'True', 'to': "orm['forms.FormEntry']"}),
            'update_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'subscribers.subscriberdata': {
            'Meta': {'unique_together': "(('subscription', 'field_label'),)", 'object_name': 'SubscriberData'},
            'field_label': ('django.db.models.fields.CharField', [], {'max_length': '2000'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subscription': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'data'", 'to': "orm['subscribers.GroupSubscription']"}),
