...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('subscribers_subscriberdata', (
            ...
            ('subscription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subscribers.GroupSubscription'])),
            ('field_label', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        # Changing field 'GroupSubscription.subscriber'
        db.alter_column('subscribers_groupsubscription', 'subscriber_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['forms.FormEntry']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'GroupSubscription.subscriber'
        db.alter_column('subscribers_groupsubscription', 'subscriber_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['forms.FormEntry']))
    ...
    models = {
        ...
        'subscribers.subscriberdata': {
            ...
            'field_label': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subscription': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['subscribers.GroupSubscription']"}),
