...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.SubscriberData.objects.all().delete()
        orm.GroupSubscription.objects.all().delete()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 19, 34, 18, 45739)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 19, 34, 18, 45637)'}),
