...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EventLog.guid'
        db.delete_column('event_logs_eventlog', 'guid')


    def backwards(self, orm):
        
        # Adding field 'EventLog.guid'
        db.add_column('event_logs_eventlog', 'guid', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 10, 33, 23, 675747)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 10, 33, 23, 675598)'}),
