...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventLog.app_color'
        db.alter_column('event_logs_eventlog', 'app_color', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'EventLog.app_color'
        db.alter_column('event_logs_eventlog', 'app_color', self.gf('django.db.models.fields.CharField')(default='', max_length=10))
    ...
    models = {
        ...
        'event_logs.eventlog': {
            ...
            'app_color': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
