...
def update_auth_domains(corp_memb, domain_names):
    ...
    """
    from tendenci.apps.corporate_memberships.models import AuthorizedDomain
...
def update_authenticate_fields(corpapp):
    ...
    """
    from tendenci.apps.corporate_memberships.models import CorpField
    if corpapp:
...
def edit_corpapp_update_memb_app(corpapp):
    ...
    if corpapp.memb_app:
        ...
        try:  
            ...
            from tendenci.apps.memberships.utils import get_default_membership_corp_fields
