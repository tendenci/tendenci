...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CorpProfile.ud6'
        db.add_column('corporate_memberships_corpprofile', 'ud6', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True), keep_default=False)

        # Adding field 'CorpProfile.ud7'
        db.add_column('corporate_memberships_corpprofile', 'ud7', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True), keep_default=False)

        # Adding field 'CorpProfile.ud8'
        db.add_column('corporate_memberships_corpprofile', 'ud8', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True), keep_default=False)

        # Changing field 'CorpProfile.ud2'
        db.alter_column('corporate_memberships_corpprofile', 'ud2', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CorpProfile.ud3'
        db.alter_column('corporate_memberships_corpprofile', 'ud3', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CorpProfile.ud1'
        db.alter_column('corporate_memberships_corpprofile', 'ud1', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CorpProfile.ud4'
        db.alter_column('corporate_memberships_corpprofile', 'ud4', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CorpProfile.ud5'
        db.alter_column('corporate_memberships_corpprofile', 'ud5', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'CorpProfile.ud6'
        db.delete_column('corporate_memberships_corpprofile', 'ud6')

        # Deleting field 'CorpProfile.ud7'
        db.delete_column('corporate_memberships_corpprofile', 'ud7')

        # Deleting field 'CorpProfile.ud8'
        db.delete_column('corporate_memberships_corpprofile', 'ud8')

        # Changing field 'CorpProfile.ud2'
        db.alter_column('corporate_memberships_corpprofile', 'ud2', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'CorpProfile.ud3'
        db.alter_column('corporate_memberships_corpprofile', 'ud3', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'CorpProfile.ud1'
        db.alter_column('corporate_memberships_corpprofile', 'ud1', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'CorpProfile.ud4'
        db.alter_column('corporate_memberships_corpprofile', 'ud4', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'CorpProfile.ud5'
        db.alter_column('corporate_memberships_corpprofile', 'ud5', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 7, 18, 17, 15, 970525)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 7, 18, 17, 15, 970417)'}),
