...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('corporate_memberships_corporatemembershiparchive', (
            ...
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='corporate_memberships_corporatemembershiparchive_entity', on_delete=models.SET_NULL, default=None, to=orm['entities.Entity'], blank=True, null=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='corporate_memberships_corporatemembershiparchive_owner', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ...
            ('archive_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='corp_memb_archiver', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ...
            ('approved_denied_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL)),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='corporate_memberships_corporatemembershiparchive_creator', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
        ...
        db.create_table('corporate_memberships_indivmembemailveri8n', (
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ime_veri8n_updator', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ime_veri8n_creator', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('corporate_membership', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['corporate_memberships.CorporateMembership'])),
            ('guid', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table('corporate_memberships_corpapp', (
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='corporate_memberships_corpapp_creator', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('authentication_method', self.gf('django.db.models.fields.CharField')(default='admin', max_length=50)),
            ('allow_user_view', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='corporate_memberships_corpapp_entity', on_delete=models.SET_NULL, default=None, to=orm['entities.Entity'], blank=True, null=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='corporate_memberships_corpapp_owner', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('guid', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('create_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('status_detail', self.gf('django.db.models.fields.CharField')(default='active', max_length=50)),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=155, unique=True)),
        ...
        db.create_table('corporate_memberships_corporatemembership', (
            ...
            ('approved_denied_dt', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='corporate_memberships_corporatemembership_creator', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('payment_method', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['payments.PaymentMethod'], null=True)),
            ('address2', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True)),
            ('renew_dt', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoices.Invoice'], null=True, blank=True)),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='corporate_memberships_corporatemembership_entity', on_delete=models.SET_NULL, default=None, to=orm['entities.Entity'], blank=True, null=True)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='corporate_memberships_corporatemembership_owner', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('corporate_membership_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['corporate_memberships.CorporateMembershipType'])),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status_detail', self.gf('django.db.models.fields.CharField')(default='active', max_length=50)),
    ...
    models = {
        ...
        'corporate_memberships.freepassesstat': {
            ...
            'allow_user_edit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_user_view': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'corp_membership': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'passes_used'", 'to': "orm['corporate_memberships.CorpMembership']"}),
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'corporate_memberships_freepassesstat_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'corporate_memberships_freepassesstat_entity'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['entities.Entity']", 'blank': 'True', 'null': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'passes_used'", 'to': "orm['events.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'corporate_memberships_freepassesstat_owner'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'registrant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['events.Registrant']", 'null': 'True'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
            'update_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        'directories.directory': {
            ...
            'logo_file': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['files.File']", 'null': 'True'}),
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
            'tags': ('tagging.fields.TagField', [], {}),
            'timezone': ('timezones.fields.TimeZoneField', [], {'default': "'US/Central'", 'max_length': '100'}),
        ...
        'events.recurringevent': {
            ...
            'starts_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'})
        },
        'events.regconfpricing': {
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 17, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'tax_rate': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '5', 'decimal_places': '4', 'blank': 'True'}),
