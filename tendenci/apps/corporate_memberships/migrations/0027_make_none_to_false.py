...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.CorporateMembershipType.objects.exclude(admin_only=True).update(admin_only=False)
        orm.CorporateMembershipType.objects.exclude(apply_threshold=True).update(apply_threshold=False)
        orm.CorporateMembershipType.objects.exclude(allow_anonymous_view=True).update(allow_anonymous_view=False)
        orm.CorporateMembershipType.objects.exclude(allow_user_view=True).update(allow_user_view=False)
        orm.CorporateMembershipType.objects.exclude(allow_member_view=True).update(allow_member_view=False)
        orm.CorporateMembershipType.objects.exclude(allow_user_edit=True).update(allow_user_edit=False)
        orm.CorporateMembershipType.objects.exclude(allow_member_edit=True).update(allow_member_edit=False)
        orm.CorporateMembershipType.objects.exclude(status=True).update(status=False)

        orm.CorpProfile.objects.exclude(tax_exempt=True).update(tax_exempt=False)
        orm.CorpProfile.objects.exclude(allow_anonymous_view=True).update(allow_anonymous_view=False)
        orm.CorpProfile.objects.exclude(allow_user_view=True).update(allow_user_view=False)
        orm.CorpProfile.objects.exclude(allow_member_view=True).update(allow_member_view=False)
        orm.CorpProfile.objects.exclude(allow_user_edit=True).update(allow_user_edit=False)
        orm.CorpProfile.objects.exclude(allow_member_edit=True).update(allow_member_edit=False)
        orm.CorpProfile.objects.exclude(status=True).update(status=False)

        orm.CorpMembership.objects.exclude(renewal=True).update(renewal=False)
        orm.CorpMembership.objects.exclude(approved=True).update(approved=False)
        orm.CorpMembership.objects.exclude(allow_anonymous_view=True).update(allow_anonymous_view=False)
        orm.CorpMembership.objects.exclude(allow_user_view=True).update(allow_user_view=False)
        orm.CorpMembership.objects.exclude(allow_member_view=True).update(allow_member_view=False)
        orm.CorpMembership.objects.exclude(allow_user_edit=True).update(allow_user_edit=False)
        orm.CorpMembership.objects.exclude(allow_member_edit=True).update(allow_member_edit=False)
        orm.CorpMembership.objects.exclude(status=True).update(status=False)

        orm.CorpMembershipAppField.objects.exclude(required=True).update(required=False)
        orm.CorpMembershipAppField.objects.exclude(display=True).update(display=False)
        orm.CorpMembershipAppField.objects.exclude(admin_only=True).update(admin_only=False)

        orm.CorpMembershipRep.objects.exclude(is_dues_rep=True).update(is_dues_rep=False)
        orm.CorpMembershipRep.objects.exclude(is_member_rep=True).update(is_member_rep=False)

        orm.IndivEmailVerification.objects.exclude(verified=True).update(verified=False)

        orm.CorpMembershipImport.objects.exclude(bind_members=True).update(bind_members=False)
        ...
        orm.NoticeLogRecord.objects.exclude(action_taken=True).update(action_taken=False)
