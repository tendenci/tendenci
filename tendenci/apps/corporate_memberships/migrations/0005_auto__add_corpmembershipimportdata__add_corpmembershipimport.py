...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CorpMembershipImportData'
        db.create_table('corporate_memberships_corpmembershipimportdata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mimport', self.gf('django.db.models.fields.related.ForeignKey')(related_name='corp_membership_import_data', to=orm['corporate_memberships.CorpMembershipImport'])),
        ...
        db.send_create_signal('corporate_memberships', ['CorpMembershipImportData'])

        # Adding model 'CorpMembershipImport'
        db.create_table('corporate_memberships_corpmembershipimport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('upload_file', self.gf('django.db.models.fields.files.FileField')(max_length=260)),
            ('override', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('key', self.gf('django.db.models.fields.CharField')(default='name', max_length=50)),
        ...
        db.send_create_signal('corporate_memberships', ['CorpMembershipImport'])


    def backwards(self, orm):
        
        # Deleting model 'CorpMembershipImportData'
        db.delete_table('corporate_memberships_corpmembershipimportdata')

        # Deleting model 'CorpMembershipImport'
        db.delete_table('corporate_memberships_corpmembershipimport')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 12, 10, 39, 35, 891096)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 12, 10, 39, 35, 890990)'}),
