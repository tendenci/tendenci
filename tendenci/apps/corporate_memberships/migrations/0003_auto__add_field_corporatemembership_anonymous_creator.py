...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CorporateMembership.anonymous_creator'
        db.add_column('corporate_memberships_corporatemembership', 'anonymous_creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='anonymous_creator', null=True, to=orm['corporate_memberships.Creator']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CorporateMembership.anonymous_creator'
        db.delete_column('corporate_memberships_corporatemembership', 'anonymous_creator_id')
    ...
    models = {
        ...
        'corporate_memberships.corporatemembership': {
            ...
            'allow_user_edit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_user_view': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'anonymous_creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'anonymous_creator'", 'null': 'True', 'to': "orm['corporate_memberships.Creator']"}),
