...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CorpMembershipAppField.description'
        db.add_column('corporate_memberships_corpmembershipappfield', 'description', self.gf('django.db.models.fields.TextField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CorpMembershipAppField.description'
        db.delete_column('corporate_memberships_corpmembershipappfield', 'description')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 10, 16, 31, 45, 434840)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 10, 16, 31, 45, 434734)'}),
