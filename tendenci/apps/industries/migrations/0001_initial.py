...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('industries_industry', (
            ...
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='industries_industry_entity', null=True, blank=True, to=orm['entities.Entity'])),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='industries_industry_creator', null=True, to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='industries_industry_owner', null=True, to=orm['auth.User'])),
            ...
            ('industry_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('industry_code', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('industries', ['Industry'])


    def backwards(self, orm):
        
        # Deleting model 'Industry'
        db.delete_table('industries_industry')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 24, 9, 29, 59, 843633)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 24, 9, 29, 59, 843525)'}),
