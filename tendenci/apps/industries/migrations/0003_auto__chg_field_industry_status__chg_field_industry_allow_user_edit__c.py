...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Industry.status'
        db.alter_column(u'industries_industry', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Industry.allow_user_edit'
        db.alter_column(u'industries_industry', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Industry.allow_user_view'
        db.alter_column(u'industries_industry', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Industry.allow_member_view'
        db.alter_column(u'industries_industry', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Industry.allow_member_edit'
        db.alter_column(u'industries_industry', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Industry.allow_anonymous_view'
        db.alter_column(u'industries_industry', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Industry.status'
        db.alter_column(u'industries_industry', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Industry.allow_user_edit'
        db.alter_column(u'industries_industry', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Industry.allow_user_view'
        db.alter_column(u'industries_industry', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Industry.allow_member_view'
        db.alter_column(u'industries_industry', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Industry.allow_member_edit'
        db.alter_column(u'industries_industry', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Industry.allow_anonymous_view'
        db.alter_column(u'industries_industry', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())
