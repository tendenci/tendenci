...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'News.allow_user_view'
        db.alter_column(u'news_news', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'News.allow_anonymous_view'
        db.alter_column(u'news_news', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'News.use_auto_timestamp'
        db.alter_column(u'news_news', 'use_auto_timestamp', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'News.syndicate'
        db.alter_column(u'news_news', 'syndicate', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'News.allow_user_edit'
        db.alter_column(u'news_news', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'News.allow_member_view'
        db.alter_column(u'news_news', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'News.allow_member_edit'
        db.alter_column(u'news_news', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'News.status'
        db.alter_column(u'news_news', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'News.allow_user_view'
        db.alter_column(u'news_news', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'News.allow_anonymous_view'
        db.alter_column(u'news_news', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'News.use_auto_timestamp'
        db.alter_column(u'news_news', 'use_auto_timestamp', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'News.syndicate'
        db.alter_column(u'news_news', 'syndicate', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'News.allow_user_edit'
        db.alter_column(u'news_news', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'News.allow_member_view'
        db.alter_column(u'news_news', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'News.allow_member_edit'
        db.alter_column(u'news_news', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'News.status'
        db.alter_column(u'news_news', 'status', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'news.news': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'news_news_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'news_news_entity'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['entities.Entity']", 'blank': 'True', 'null': 'True'}),
            'fax': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'news_news_owner'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'thumbnail': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['news.NewsImage']", 'null': 'True'}),
            'timezone': ('timezones.fields.TimeZoneField', [], {'default': "'US/Central'", 'max_length': '100'}),
            'update_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'use_auto_timestamp': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'website': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'})
        },
        u'news.newsimage': {
            'Meta': {'object_name': 'NewsImage', '_ormbases': [u'files.File']},
