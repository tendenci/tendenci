...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.release_dt_local'
        db.add_column('news_news', 'release_dt_local',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.release_dt_local'
        db.delete_column('news_news', 'release_dt_local')
