...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.contributor_type'
        db.add_column('news_news', 'contributor_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.contributor_type'
        db.delete_column('news_news', 'contributor_type')
