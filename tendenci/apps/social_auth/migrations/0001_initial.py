...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'social_auth_usersocialauth', (
            ...
            ('extra_data', self.gf('tendenci.apps.social_auth.fields.JSONField')(blank=True)),
        ))
        db.send_create_signal(u'social_auth', ['UserSocialAuth'])
        ...
        db.send_create_signal(u'social_auth', ['Nonce'])
        ...
        db.send_create_signal(u'social_auth', ['Association'])
