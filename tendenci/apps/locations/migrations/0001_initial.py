...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('locations_location', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='locations_location_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='locations_location_owner', to=orm['auth.User'])),
            ...
            ('location_name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ...
            ('hq', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        # Adding model 'LocationImport'
        db.create_table('locations_locationimport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('create_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('locations', ['LocationImport'])

        # Adding model 'Distance'
        db.create_table('locations_distance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('zip_code', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'])),
            ('distance', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('locations', ['Distance'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'LocationImport'
        db.delete_table('locations_locationimport')

        # Deleting model 'Distance'
        db.delete_table('locations_distance')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 24, 42, 461817)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 24, 42, 461729)'}),
        ...
        'locations.location': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'locations_location_creator'", 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'locations_location_owner'", 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
