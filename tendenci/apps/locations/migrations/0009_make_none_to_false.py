...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Location.objects.exclude(hq=True).update(hq=False)
        orm.Location.objects.exclude(allow_anonymous_view=True).update(allow_anonymous_view=False)
        orm.Location.objects.exclude(allow_user_view=True).update(allow_user_view=False)
        orm.Location.objects.exclude(allow_member_view=True).update(allow_member_view=False)
        orm.Location.objects.exclude(allow_user_edit=True).update(allow_user_edit=False)
        orm.Location.objects.exclude(allow_member_edit=True).update(allow_member_edit=False)
        orm.Location.objects.exclude(status=True).update(status=False)
    ...
    models = {
        ...
        u'locations.location': {
            ...
            'fax': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'hq': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
