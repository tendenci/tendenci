...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.status'
        db.alter_column(u'locations_location', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Location.allow_user_view'
        db.alter_column(u'locations_location', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Location.allow_anonymous_view'
        db.alter_column(u'locations_location', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Location.hq'
        db.alter_column(u'locations_location', 'hq', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Location.allow_user_edit'
        db.alter_column(u'locations_location', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Location.allow_member_view'
        db.alter_column(u'locations_location', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Location.allow_member_edit'
        db.alter_column(u'locations_location', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Location.status'
        db.alter_column(u'locations_location', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Location.allow_user_view'
        db.alter_column(u'locations_location', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Location.allow_anonymous_view'
        db.alter_column(u'locations_location', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Location.hq'
        db.alter_column(u'locations_location', 'hq', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Location.allow_user_edit'
        db.alter_column(u'locations_location', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Location.allow_member_view'
        db.alter_column(u'locations_location', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Location.allow_member_edit'
        db.alter_column(u'locations_location', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        u'locations.distance': {
            'Meta': {'object_name': 'Distance'},
            'distance': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'locations.location': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'locations_location_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '120', 'blank': 'True'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'locations_location_entity'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['entities.Entity']", 'blank': 'True', 'null': 'True'}),
            'fax': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'hq': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'location_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'logo': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['files.File']", 'null': 'True'}),
            'longitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'locations_location_owner'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
        ...
        u'locations.locationimport': {
            'Meta': {'object_name': 'LocationImport'},
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
