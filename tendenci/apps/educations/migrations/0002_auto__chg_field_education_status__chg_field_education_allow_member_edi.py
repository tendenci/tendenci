...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'educations_education', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
        ...
        db.alter_column(u'educations_education', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Education.entity'
        db.alter_column(u'educations_education', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['entities.Entity'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Education.creator'
        db.alter_column(u'educations_education', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Education.allow_member_view'
        db.alter_column(u'educations_education', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Education.owner'
        db.alter_column(u'educations_education', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Education.entity'
        db.alter_column(u'educations_education', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['entities.Entity']))
