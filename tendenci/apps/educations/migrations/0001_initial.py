...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('educations_education', (
            ...
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='educations_education_entity', null=True, blank=True, to=orm['entities.Entity'])),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='educations_education_creator', null=True, to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='educations_education_owner', null=True, to=orm['auth.User'])),
            ...
            ('school', self.gf('django.db.models.fields.CharField')(max_length=350)),
            ('major', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('degree', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('graduation_dt', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='educations', to=orm['auth.User'])),
        ))
        db.send_create_signal('educations', ['Education'])


    def backwards(self, orm):
        
        # Deleting model 'Education'
        db.delete_table('educations_education')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 24, 12, 0, 50, 286076)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 24, 12, 0, 50, 285969)'}),
        ...
        'educations.education': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'educations_education_creator'", 'null': 'True', 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'degree': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'educations_education_entity'", 'null': 'True', 'blank': 'True', 'to': "orm['entities.Entity']"}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'educations_education_owner'", 'null': 'True', 'to': "orm['auth.User']"}),
