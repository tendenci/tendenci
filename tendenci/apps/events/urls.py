...
urlpatterns = [
    ...
    re_path(r'^%s/file/delete/(?P<event_file_id>\d+)/$' % urlpath, views.event_file_delete, name="event.file_delete"),
    re_path(r'^%s/files-display/(?P<event_id>\d+)/$' % urlpath, views.event_files_display, name="event.files_display"),
    re_path(r'^%s/files/search/$' % urlpath, views.event_files_search, name="event.files_search"),
    ...
    re_path(r'^%s/assets-purchase/(?P<event_id>\d+)/$' % urlpath, views.purchase_assets, name='event.purchase_assets'),
