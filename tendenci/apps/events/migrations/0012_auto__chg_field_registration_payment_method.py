...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("payments", "0002_auto__add_field_paymentmethod_admin_only"),
    )

    def forwards(self, orm):
        
        # Changing field 'Registration.payment_method'
        db.alter_column('events_registration', 'payment_method_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.PaymentMethod'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Registration.payment_method'
        db.alter_column('events_registration', 'payment_method_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.PaymentMethod'], null=True))
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 29, 15, 16, 50, 631893)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 29, 15, 16, 50, 631858)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
