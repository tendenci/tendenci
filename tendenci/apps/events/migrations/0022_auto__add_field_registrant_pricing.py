...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Registrant.pricing'
        db.add_column('events_registrant', 'pricing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.RegConfPricing'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Registrant.pricing'
        db.delete_column('events_registrant', 'pricing_id')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 6, 17, 21, 35, 278369)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 6, 15, 21, 35, 278274)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 6, 21, 21, 35, 264490)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 6, 15, 21, 35, 264435)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
