...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_registrationconfiguration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('payment_required', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('limit', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('require_guests_info', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_guest_price', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('discount_eligible', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('use_custom_reg_form', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('reg_form', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='regconfs', null=True, to=orm['events.CustomRegForm'])),
            ('bind_reg_form_to_conf_only', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        # Adding model 'RegConfPricing'
        db.create_table('events_regconfpricing', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reg_conf', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.RegistrationConfiguration'], null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True)),
            ...
            ('price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2)),
            ('reg_form', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='regconfpricings', null=True, to=orm['events.CustomRegForm'])),
            ('start_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 19, 15, 21, 17, 454832))),
            ('end_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 19, 21, 21, 17, 454857))),
        ...
        db.create_table('events_registration', (
            ...
            ('reg_conf_price', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.RegConfPricing'], null=True)),
            ...
            ('is_table', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('override_table', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('override_price_table', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2, blank=True)),
            ('discount_code', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('discount_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2)),
        ...
        db.create_table('events_registrant', (
            ...
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2, blank=True)),
            ('pricing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.RegConfPricing'], null=True)),
            ('custom_reg_form_entry', self.gf('django.db.models.fields.related.ForeignKey')(related_name='registrants', null=True, to=orm['events.CustomRegFormEntry'])),
            ...
            ('meal_option', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ...
            ('override_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2, blank=True)),
            ('discount_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2)),
            ('cancel_dt', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('memberid', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('checked_in', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('checked_in_dt', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('reminder', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('create_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        ...
        db.create_table('events_event', (
            ...
            ('create_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='events_event_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='events_event_owner', to=orm['auth.User'])),
            ...
            ('start_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 19, 15, 21, 17, 462716))),
            ('end_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 19, 17, 21, 17, 462752))),
            ...
            ('on_weekend', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('external_url', self.gf('django.db.models.fields.URLField')(default=u'', max_length=200, blank=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.EventPhoto'], null=True, blank=True)),
            ('tags', self.gf('tagging.fields.TagField')()),
            ('meta', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['meta.Meta'], unique=True, null=True)),
        ))
        db.send_create_signal('events', ['Event'])

        # Adding model 'CustomRegForm'
        db.create_table('events_customregform', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('notes', self.gf('django.db.models.fields.TextField')(max_length=2000, blank=True)),
            ('create_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='custom_reg_creator', null=True, to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='custom_reg_owner', null=True, to=orm['auth.User'])),
            ('owner_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('status', self.gf('django.db.models.fields.CharField')(default='active', max_length=50)),
            ('first_name', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('last_name', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('mail_name', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('address', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('zip', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('country', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('phone', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('email', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('position_title', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('company_name', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('meal_option', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('comments', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('events', ['CustomRegForm'])

        # Adding model 'CustomRegField'
        db.create_table('events_customregfield', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('form', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fields', to=orm['events.CustomRegForm'])),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('map_to_field', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ...
            ('display_on_roster', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('events', ['CustomRegField'])

        # Adding model 'CustomRegFormEntry'
        db.create_table('events_customregformentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('form', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries', to=orm['events.CustomRegForm'])),
            ('entry_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('events', ['CustomRegFormEntry'])

        # Adding model 'CustomRegFieldEntry'
        db.create_table('events_customregfieldentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(related_name='field_entries', to=orm['events.CustomRegFormEntry'])),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries', to=orm['events.CustomRegField'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ))
        db.send_create_signal('events', ['CustomRegFieldEntry'])

        # Adding model 'EventPhoto'
        db.create_table('events_eventphoto', (
            ('file_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['files.File'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('events', ['EventPhoto'])

        # Adding model 'Addon'
        db.create_table('events_addon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
        ...
        db.send_create_signal('events', ['Addon'])

        # Adding model 'AddonOption'
        db.create_table('events_addonoption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('addon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='options', to=orm['events.Addon'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('events', ['AddonOption'])

        # Adding model 'RegAddon'
        db.create_table('events_regaddon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('registration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Registration'])),
            ('addon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Addon'])),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2)),
            ('create_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('events', ['RegAddon'])

        # Adding model 'RegAddonOption'
        db.create_table('events_regaddonoption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('regaddon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.RegAddon'])),
            ('option', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.AddonOption'])),
        ))
        db.send_create_signal('events', ['RegAddonOption'])

        # Adding unique constraint on 'RegAddonOption', fields ['regaddon', 'option']
        db.create_unique('events_regaddonoption', ['regaddon_id', 'option_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'RegAddonOption', fields ['regaddon', 'option']
        db.delete_unique('events_regaddonoption', ['regaddon_id', 'option_id'])
        ...
        # Deleting model 'RegConfPricing'
        db.delete_table('events_regconfpricing')
        ...
        # Deleting model 'CustomRegForm'
        db.delete_table('events_customregform')

        # Deleting model 'CustomRegField'
        db.delete_table('events_customregfield')

        # Deleting model 'CustomRegFormEntry'
        db.delete_table('events_customregformentry')

        # Deleting model 'CustomRegFieldEntry'
        db.delete_table('events_customregfieldentry')

        # Deleting model 'EventPhoto'
        db.delete_table('events_eventphoto')

        # Deleting model 'Addon'
        db.delete_table('events_addon')

        # Deleting model 'AddonOption'
        db.delete_table('events_addonoption')

        # Deleting model 'RegAddon'
        db.delete_table('events_regaddon')

        # Deleting model 'RegAddonOption'
        db.delete_table('events_regaddonoption')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 21, 17, 839522)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 21, 17, 839432)'}),
        ...
        'events.event': {
            ...
            'allow_user_view': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events_event_creator'", 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 19, 17, 21, 17, 462752)'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events_event_owner'", 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 19, 15, 21, 17, 462716)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            'Meta': {'object_name': 'RegConfPricing'},
            'allow_anonymous': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_member': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_user': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'display_order': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 19, 21, 21, 17, 454857)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 21, 17, 454832)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
