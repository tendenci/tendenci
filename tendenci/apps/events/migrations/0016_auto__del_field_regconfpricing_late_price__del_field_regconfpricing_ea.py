...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('events_regconfpricing', 'early_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 22, 12, 36, 24, 853427)), keep_default=False)

        # Adding field 'RegConfPricing.late_dt'
        db.add_column('events_regconfpricing', 'late_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 22, 16, 36, 24, 853618)), keep_default=False)

        # Adding field 'RegConfPricing.regular_dt'
        db.add_column('events_regconfpricing', 'regular_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 22, 14, 36, 24, 853500)), keep_default=False)
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 16, 53, 24, 424811)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 14, 53, 24, 424727)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 20, 53, 24, 411872)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 14, 53, 24, 411818)'}),
