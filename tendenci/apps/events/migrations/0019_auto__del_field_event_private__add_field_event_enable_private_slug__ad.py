...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.private'
        db.delete_column('events_event', 'private')

        # Adding field 'Event.enable_private_slug'
        db.add_column('events_event', 'enable_private_slug',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Event.private_slug'
        db.add_column('events_event', 'private_slug',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Event.private'
        db.add_column('events_event', 'private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Event.enable_private_slug'
        db.delete_column('events_event', 'enable_private_slug')

        # Deleting field 'Event.private_slug'
        db.delete_column('events_event', 'private_slug')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 6, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
