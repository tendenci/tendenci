...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Registrant.checked_in'
        db.add_column('events_registrant', 'checked_in', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Registrant.checked_in_dt'
        db.add_column('events_registrant', 'checked_in_dt', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Registrant.checked_in'
        db.delete_column('events_registrant', 'checked_in')

        # Deleting field 'Registrant.checked_in_dt'
        db.delete_column('events_registrant', 'checked_in_dt')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 10, 11, 53, 43, 271208)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 10, 9, 53, 43, 271173)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 10, 15, 53, 43, 262860)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 11, 9, 53, 43, 262834)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
