...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RegistrationConfiguration.honor_system'
        db.delete_column('events_registrationconfiguration', 'honor_system')

        # Adding field 'RegistrationConfiguration.require_guests_info'
        db.add_column('events_registrationconfiguration', 'require_guests_info', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RegistrationConfiguration.honor_system'
        db.add_column('events_registrationconfiguration', 'honor_system', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'RegistrationConfiguration.require_guests_info'
        db.delete_column('events_registrationconfiguration', 'require_guests_info')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 11, 16, 33, 0, 445006)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 11, 14, 33, 0, 444973)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 11, 20, 33, 0, 436903)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 11, 14, 33, 0, 436872)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
