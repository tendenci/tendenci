...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegConfPricing.price'
        db.add_column('events_regconfpricing', 'price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2), keep_default=False)

        # Adding field 'RegConfPricing.date'
        db.add_column('events_regconfpricing', 'date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 22, 12, 35, 19, 547028)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegConfPricing.price'
        db.delete_column('events_regconfpricing', 'price')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 14, 35, 19, 559935)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 12, 35, 19, 559884)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 12, 35, 19, 547028)'}),
            'early_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 12, 35, 19, 546976)'}),
            'early_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 18, 35, 19, 547028)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'late_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 16, 35, 19, 547028)'}),
            ...
            'regular_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 14, 35, 19, 547028)'}),
