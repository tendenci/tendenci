...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegistrationConfiguration.email'
        db.add_column('events_registrationconfiguration', 'email', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emails.Email'], null=True), keep_default=False)

        # Adding field 'RegistrationConfiguration.send_reminder'
        db.add_column('events_registrationconfiguration', 'send_reminder', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'RegistrationConfiguration.reminder_days'
        db.add_column('events_registrationconfiguration', 'reminder_days', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegistrationConfiguration.email'
        db.delete_column('events_registrationconfiguration', 'email_id')

        # Deleting field 'RegistrationConfiguration.send_reminder'
        db.delete_column('events_registrationconfiguration', 'send_reminder')

        # Deleting field 'RegistrationConfiguration.reminder_days'
        db.delete_column('events_registrationconfiguration', 'reminder_days')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 26, 15, 12, 47, 17383)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 26, 15, 12, 47, 17130)'}),
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 17, 12, 45, 542713)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 15, 12, 45, 542680)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 21, 12, 45, 534381)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 26, 15, 12, 45, 534349)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
