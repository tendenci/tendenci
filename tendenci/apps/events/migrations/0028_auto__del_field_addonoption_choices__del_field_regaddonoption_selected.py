...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AddonOption.choices'
        db.delete_column('events_addonoption', 'choices')

        # Deleting field 'RegAddonOption.selected_option'
        db.delete_column('events_regaddonoption', 'selected_option')


    def backwards(self, orm):
        
        # Adding field 'AddonOption.choices'
        db.add_column('events_addonoption', 'choices', self.gf('django.db.models.fields.CharField')(default='choice1, choice2', max_length=200), keep_default=False)

        # Adding field 'RegAddonOption.selected_option'
        db.add_column('events_regaddonoption', 'selected_option', self.gf('django.db.models.fields.CharField')(default='choice1', max_length=50), keep_default=False)
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 23, 9, 42, 27, 294007)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 23, 7, 42, 27, 293969)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'allow_member': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_user': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 23, 13, 42, 27, 287844)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 23, 7, 42, 27, 287806)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
