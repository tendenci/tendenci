...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegConfPricing.description'
        db.add_column('events_regconfpricing', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'RegConfPricing.title'
        db.alter_column('events_regconfpricing', 'title', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):
        # Deleting field 'RegConfPricing.description'
        db.delete_column('events_regconfpricing', 'description')


        # Changing field 'RegConfPricing.title'
        db.alter_column('events_regconfpricing', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 13, 0, 0)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 13, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.recurringevent': {
            ...
            'starts_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 13, 0, 0)'})
        },
        'events.regaddon': {
        ...
        'events.regconfpricing': {
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 14, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
