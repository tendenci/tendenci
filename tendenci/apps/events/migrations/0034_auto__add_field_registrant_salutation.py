...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Registrant.salutation'
        db.add_column(u'events_registrant', 'salutation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Registrant.salutation'
        db.delete_column(u'events_registrant', 'salutation')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 13, 0, 0)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 13, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        u'events.recurringevent': {
            ...
            'starts_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 13, 0, 0)'})
        },
        u'events.regaddon': {
        ...
        u'events.regconfpricing': {
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 14, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'events.registrant': {
            ...
            'salutation': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '15', 'blank': 'True'}),
