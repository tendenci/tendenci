...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RegConfPricing.date'
        db.delete_column('events_regconfpricing', 'date')

        # Adding field 'RegConfPricing.start_dt'
        db.add_column('events_regconfpricing', 'start_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 22, 13, 16, 9, 186114)), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RegConfPricing.date'
        db.add_column('events_regconfpricing', 'date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 22, 12, 36, 24, 853670)), keep_default=False)

        # Deleting field 'RegConfPricing.start_dt'
        db.delete_column('events_regconfpricing', 'start_dt')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 15, 16, 9, 198269)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 13, 16, 9, 198217)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'early_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 13, 16, 9, 185916)'}),
            'early_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 19, 16, 9, 186157)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'late_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 17, 16, 9, 186047)'}),
            ...
            'regular_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 15, 16, 9, 185970)'}),
            'regular_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 13, 16, 9, 186114)'}),
