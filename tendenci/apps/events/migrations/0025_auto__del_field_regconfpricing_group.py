...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RegConfPricing.group'
        db.delete_column('events_regconfpricing', 'group_id')


    def backwards(self, orm):
        # Adding field 'RegConfPricing.group'
        db.add_column('events_regconfpricing', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='old_pricing_set', null=True, to=orm['user_groups.Group'], blank=True),
                      keep_default=False)
