    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator_username', models.CharField(default=b'', max_length=50)),
                ('owner_username', models.CharField(default=b'', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_dt', models.DateTimeField(auto_now_add=True)),
                ('status', models.BooleanField(default=True)),
                ('account', models.ForeignKey(related_name='accts', to='accountings.Acct', null=True)),
                ('acct_entry', models.ForeignKey(related_name='trans', to='accountings.AcctEntry')),
