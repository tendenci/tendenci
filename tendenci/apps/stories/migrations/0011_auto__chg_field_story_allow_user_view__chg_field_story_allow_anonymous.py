...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'stories_story', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Story.allow_anonymous_view'
        db.alter_column(u'stories_story', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Story.status'
        db.alter_column(u'stories_story', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Story.expires'
        db.alter_column(u'stories_story', 'expires', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Story.syndicate'
        db.alter_column(u'stories_story', 'syndicate', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Story.allow_user_edit'
        db.alter_column(u'stories_story', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Story.allow_member_view'
        db.alter_column(u'stories_story', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Story.allow_member_edit'
        db.alter_column(u'stories_story', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Story.allow_user_view'
        db.alter_column(u'stories_story', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Story.allow_anonymous_view'
        db.alter_column(u'stories_story', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Story.status'
        db.alter_column(u'stories_story', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Story.expires'
        db.alter_column(u'stories_story', 'expires', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Story.syndicate'
        db.alter_column(u'stories_story', 'syndicate', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Story.allow_user_edit'
        db.alter_column(u'stories_story', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Story.allow_member_view'
        db.alter_column(u'stories_story', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Story.allow_member_edit'
        db.alter_column(u'stories_story', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        u'stories.story': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'stories_story_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'stories_story_entity'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['entities.Entity']", 'blank': 'True', 'null': 'True'}),
            ...
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['stories.StoryPhoto']", 'null': 'True'}),
            'link_title': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'stories_story_owner'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'position': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'rotator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['stories.Rotator']", 'null': 'True', 'blank': 'True'}),
            'rotator_position': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
        ...
        u'stories.storyphoto': {
            'Meta': {'object_name': 'StoryPhoto', '_ormbases': [u'files.File']},
