...
import tendenci.apps.helpdesk.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=tendenci.apps.helpdesk.models.attachment_path, verbose_name='File', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public', models.BooleanField(verbose_name='Public', blank=True, default=False, help_text='Public tickets are viewable by the submitter and all staff, but non-public tickets can only be seen by staff.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keep_in_mailbox', models.BooleanField(verbose_name='Save Emails in Mailbox?', blank=True, default=False, help_text='Do you want to save emails from this address in the mailbox? If this is unticked, emails from this address will be deleted.')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(verbose_name='Category', to='helpdesk.KBCategory', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allow_public_submission', models.BooleanField(verbose_name='Allow Public Submission?', blank=True, default=False, help_text='Should this queue be listed on the public submission form?')),
                ('allow_email_submission', models.BooleanField(verbose_name='Allow E-Mail Submission?', blank=True, default=False, help_text='Do you want to poll the e-mail box below for new tickets?')),
                ...
                ('email_box_ssl', models.BooleanField(verbose_name='Use SSL for E-Mail?', blank=True, default=False, help_text='Whether to use SSL for IMAP or POP3 - the default ports when using SSL are 993 for IMAP and 995 for POP3.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shared', models.BooleanField(verbose_name='Shared With Other Users?', blank=True, default=False, help_text='Should other users see this query?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('on_hold', models.BooleanField(verbose_name='On Hold', blank=True, default=False, help_text='If a ticket is on hold, it will not automatically be escalated.')),
                ...
                ('assigned_to', models.ForeignKey(null=True, verbose_name='Assigned to', blank=True, related_name='assigned_to', to=settings.AUTH_USER_MODEL, on_delete=django.db.models.deletion.CASCADE)),
                ('queue', models.ForeignKey(verbose_name='Queue', to='helpdesk.Queue', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('can_view', models.BooleanField(verbose_name='Can View Ticket?', blank=True, default=False, help_text='Can this CC login to view the ticket details?')),
                ('can_update', models.BooleanField(verbose_name='Can Update Ticket?', blank=True, default=False, help_text='Can this CC login and update the ticket?')),
                ('ticket', models.ForeignKey(verbose_name='Ticket', to='helpdesk.Ticket', on_delete=django.db.models.deletion.CASCADE)),
                ('user', models.ForeignKey(null=True, verbose_name='User', blank=True, to=settings.AUTH_USER_MODEL, help_text='User who wishes to receive updates for this ticket.', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followup', models.ForeignKey(verbose_name='Follow-up', to='helpdesk.FollowUp', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.ForeignKey(verbose_name='Field', to='helpdesk.CustomField', on_delete=django.db.models.deletion.CASCADE)),
                ('ticket', models.ForeignKey(verbose_name='Ticket', to='helpdesk.Ticket', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='followup',
            name='ticket',
            field=models.ForeignKey(verbose_name='Ticket', to='helpdesk.Ticket', on_delete=django.db.models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='followup',
            name='user',
            field=models.ForeignKey(null=True, verbose_name='User', blank=True, to=settings.AUTH_USER_MODEL, on_delete=django.db.models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='followup',
            field=models.ForeignKey(verbose_name='Follow-up', to='helpdesk.FollowUp', on_delete=django.db.models.deletion.CASCADE),
            preserve_default=True,
        ),
    ]
