...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'File.allow_user_view'
        db.alter_column(u'files_file', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'File.allow_anonymous_view'
        db.alter_column(u'files_file', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'File.status'
        db.alter_column(u'files_file', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'File.is_public'
        db.alter_column(u'files_file', 'is_public', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'File.allow_user_edit'
        db.alter_column(u'files_file', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'File.allow_member_view'
        db.alter_column(u'files_file', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'File.allow_member_edit'
        db.alter_column(u'files_file', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'File.allow_user_view'
        db.alter_column(u'files_file', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'File.allow_anonymous_view'
        db.alter_column(u'files_file', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'File.status'
        db.alter_column(u'files_file', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'File.is_public'
        db.alter_column(u'files_file', 'is_public', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'File.allow_user_edit'
        db.alter_column(u'files_file', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'File.allow_member_view'
        db.alter_column(u'files_file', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'File.allow_member_edit'
        db.alter_column(u'files_file', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'files.multiplefile': {
            'Meta': {'object_name': 'MultipleFile', 'managed': 'False'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'user_groups.group': {
