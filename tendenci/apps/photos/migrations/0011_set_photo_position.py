...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        # Pass since we don't know what position to reverse to
        pass
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 17, 14, 2, 44, 472997)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 17, 14, 2, 44, 472904)'}),
