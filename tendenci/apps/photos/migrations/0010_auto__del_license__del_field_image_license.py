...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Image.license'
        db.delete_column('photos_image', 'license_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('photos_image', 'license', self.gf('django.db.models.fields.related.ForeignKey')(related_name='license', null=True, to=orm['photos.License'], blank=True), keep_default=False)
