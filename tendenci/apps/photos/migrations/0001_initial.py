...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('photos_photoeffect', (
        ...
        db.send_create_signal('photos', ['PhotoEffect'])

        # Adding model 'Watermark'
        db.create_table('photos_watermark', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.send_create_signal('photos', ['Watermark'])

        # Adding model 'PhotoSize'
        db.create_table('photos_photosize', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('effect', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='photo_sizes', null=True, to=orm['photos.PhotoEffect'])),
            ('watermark', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='photo_sizes', null=True, to=orm['photos.Watermark'])),
        ))
        db.send_create_signal('photos', ['PhotoSize'])
        ...
        db.create_table('photos_photoset', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photos_photoset_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photos_photoset_owner', to=orm['auth.User'])),
        ...
        db.create_table('photos_image', (
            ...
            ('create_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photos_image_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photos_image_owner', to=orm['auth.User'])),
            ('owner_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('status_detail', self.gf('django.db.models.fields.CharField')(default='active', max_length=50)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ...
            ('effect', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='image_related', null=True, to=orm['photos.PhotoEffect'])),
            ('guid', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ...
            ('tags', self.gf('tagging.fields.TagField')()),
            ('license', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.License'], null=True, blank=True)),
            ('meta', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['meta.Meta'], unique=True, null=True, blank=True)),
        ))
        ...
        db.create_table('photos_license', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ...
            ('deed', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('legal_code', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('photos', ['License'])
        ...
        db.create_table('photos_albumcover', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photoset', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['photos.PhotoSet'], unique=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Image'])),
        ))
        db.send_create_signal('photos', ['AlbumCover'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('photos_photoeffect')

        # Deleting model 'Watermark'
        db.delete_table('photos_watermark')

        # Deleting model 'PhotoSize'
        db.delete_table('photos_photosize')
        ...
        db.delete_table('photos_license')

        # Deleting model 'Pool'
        db.delete_table('photos_pool')

        # Deleting model 'AlbumCover'
        db.delete_table('photos_albumcover')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 21, 32, 148344)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 21, 32, 148255)'}),
        ...
        'photos.image': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos_image_creator'", 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos_image_owner'", 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'photos.photoset': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos_photoset_creator'", 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos_photoset_owner'", 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
