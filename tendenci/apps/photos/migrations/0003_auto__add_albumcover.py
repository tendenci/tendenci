...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('photos_albumcover', (
            ...
            ('photoset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.PhotoSet'], unique=True)),
    ...
    models = {
        ...
        'photos.albumcover': {
            ...
            'photoset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['photos.PhotoSet']", 'unique': 'True'})
        },
        'photos.image': {
