...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.group'
        db.add_column('photos_image', 'group', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['user_groups.Group'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'PhotoSet.group'
        db.alter_column('photos_photoset', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True))

        # Deleting field 'Image.group'
        db.delete_column('photos_image', 'group_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 11, 17, 10, 32, 170447)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 11, 17, 10, 32, 170300)'}),
