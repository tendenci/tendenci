...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AlbumCover.photoset'
        db.alter_column('photos_albumcover', 'photoset_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['photos.PhotoSet'], unique=True))


    def backwards(self, orm):
        
        # Changing field 'AlbumCover.photoset'
        db.alter_column('photos_albumcover', 'photoset_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.PhotoSet'], unique=True))
