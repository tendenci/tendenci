...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('payments_payment', (
            ...
            ('payment_attempted', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ...
            ('company', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('address', self.gf('django.db.models.fields.CharField')(default='', max_length=60, null=True)),
            ('address2', self.gf('django.db.models.fields.CharField')(default='', max_length=60, null=True)),
            ('city', self.gf('django.db.models.fields.CharField')(default='', max_length=40, null=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='', max_length=40, null=True)),
            ('zip', self.gf('django.db.models.fields.CharField')(default='', max_length=20, null=True)),
            ('country', self.gf('django.db.models.fields.CharField')(default='', max_length=60, null=True)),
            ('phone', self.gf('django.db.models.fields.CharField')(default='', max_length=25, null=True)),
            ('fax', self.gf('django.db.models.fields.CharField')(default='', max_length=25, null=True)),
            ('email', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
