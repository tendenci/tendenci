...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('payments_payment', (
            ...
            ('payment_attempted', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('response_code', self.gf('django.db.models.fields.CharField')(default='', max_length=2)),
            ('response_subcode', self.gf('django.db.models.fields.CharField')(default='', max_length=10)),
            ('response_reason_code', self.gf('django.db.models.fields.CharField')(default='', max_length=15)),
            ('response_reason_text', self.gf('django.db.models.fields.TextField')(default='')),
            ('response_page', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('trans_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('trans_string', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('card_type', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('account_number', self.gf('django.db.models.fields.CharField')(default='', max_length=4, null=True)),
            ('po_num', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ...
            ('description', self.gf('django.db.models.fields.CharField')(max_length=1600)),
            ('first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True)),
            ('last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True)),
            ('company', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True, blank=True)),
            ('address', self.gf('django.db.models.fields.CharField')(default='', max_length=60, null=True, blank=True)),
            ('address2', self.gf('django.db.models.fields.CharField')(default='', max_length=60, null=True, blank=True)),
            ('city', self.gf('django.db.models.fields.CharField')(default='', max_length=40, null=True, blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='', max_length=40, null=True, blank=True)),
            ('zip', self.gf('django.db.models.fields.CharField')(default='', max_length=20, null=True, blank=True)),
            ('country', self.gf('django.db.models.fields.CharField')(default='', max_length=60, null=True, blank=True)),
            ('phone', self.gf('django.db.models.fields.CharField')(default='', max_length=25, null=True, blank=True)),
            ('fax', self.gf('django.db.models.fields.CharField')(default='', max_length=25, null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
            ('ship_to_first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True)),
            ('ship_to_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True)),
            ('ship_to_company', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('ship_to_address', self.gf('django.db.models.fields.CharField')(default='', max_length=60, null=True)),
            ('ship_to_city', self.gf('django.db.models.fields.CharField')(default='', max_length=40, null=True)),
            ('ship_to_state', self.gf('django.db.models.fields.CharField')(default='', max_length=40, null=True)),
            ('ship_to_zip', self.gf('django.db.models.fields.CharField')(default='', max_length=20, null=True)),
            ('ship_to_country', self.gf('django.db.models.fields.CharField')(default='', max_length=60, null=True)),
            ...
            ('cust_id', self.gf('django.db.models.fields.CharField')(default=0, max_length=20)),
            ...
            ('submit_dt', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_creator', null=True, to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_owner', null=True, to=orm['auth.User'])),
            ('owner_username', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('status_detail', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('payments', ['Payment'])

        # Adding model 'PaymentMethod'
        db.create_table('payments_paymentmethod', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('human_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal('payments', ['PaymentMethod'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('payments_paymentmethod')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 14, 10, 8, 43, 875024)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 14, 10, 8, 43, 874903)'}),
