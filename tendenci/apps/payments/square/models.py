...
class SquareAccount(TendenciBaseModel):
    """
    A Square connected account
    """
    user = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL, related_name="square_accounts")
...
class Charge(models.Model):
    account = models.ForeignKey(SquareAccount, related_name="square_charges", on_delete=models.CASCADE)
