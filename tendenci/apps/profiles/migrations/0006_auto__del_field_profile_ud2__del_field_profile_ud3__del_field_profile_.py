...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('profiles_profile', 'ud2', self.gf('django.db.models.fields.TextField')(default=u'', blank=True), keep_default=False)

        # Adding field 'Profile.ud3'
        db.add_column('profiles_profile', 'ud3', self.gf('django.db.models.fields.TextField')(default=u'', blank=True), keep_default=False)

        # Adding field 'Profile.ud1'
        db.add_column('profiles_profile', 'ud1', self.gf('django.db.models.fields.TextField')(default=u'', blank=True), keep_default=False)
        ...
        db.add_column('profiles_profile', 'ud4', self.gf('django.db.models.fields.TextField')(default=u'', blank=True), keep_default=False)

        # Adding field 'Profile.ud5'
        db.add_column('profiles_profile', 'ud5', self.gf('django.db.models.fields.TextField')(default=u'', blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 17, 23, 4, 531668)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 17, 23, 4, 531567)'}),
