...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.total_spend'
        db.add_column('profiles_profile', 'total_spend',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.total_spend'
        db.delete_column('profiles_profile', 'total_spend')
