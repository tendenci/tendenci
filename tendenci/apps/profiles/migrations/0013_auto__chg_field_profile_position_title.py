...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.position_title'
        db.alter_column('profiles_profile', 'position_title', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Profile.position_title'
        db.alter_column('profiles_profile', 'position_title', self.gf('django.db.models.fields.CharField')(max_length=50))
