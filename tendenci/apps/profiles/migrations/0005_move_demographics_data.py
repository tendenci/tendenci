...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Move data from profiles table to memberships demographics table"
        ud_fields = ['ud1', 'ud2', 'ud3', 'ud4', 'ud5',
        ...
        for p in profiles:
            ...
            for ud in ud_fields:
                if getattr(p, ud):
                    if not mem_dem:
                        mem_dem = orm['memberships.MembershipDemographic'](user=p.user)
                    setattr(mem_dem, ud, getattr(p, ud))
            if mem_dem:
                mem_dem.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 17, 22, 53, 590520)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 17, 22, 53, 590422)'}),
