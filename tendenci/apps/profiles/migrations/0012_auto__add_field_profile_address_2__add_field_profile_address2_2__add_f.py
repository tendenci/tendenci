...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_profile', 'address_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)

        # Adding field 'Profile.address2_2'
        db.add_column('profiles_profile', 'address2_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Profile.member_number_2'
        db.add_column('profiles_profile', 'member_number_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Profile.city_2'
        db.add_column('profiles_profile', 'city_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Profile.state_2'
        db.add_column('profiles_profile', 'state_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Profile.zipcode_2'
        db.add_column('profiles_profile', 'zipcode_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Profile.county_2'
        db.add_column('profiles_profile', 'county_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Profile.country_2'
        db.add_column('profiles_profile', 'country_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('profiles_profile', 'address_2')

        # Deleting field 'Profile.address2_2'
        db.delete_column('profiles_profile', 'address2_2')

        # Deleting field 'Profile.member_number_2'
        db.delete_column('profiles_profile', 'member_number_2')

        # Deleting field 'Profile.city_2'
        db.delete_column('profiles_profile', 'city_2')

        # Deleting field 'Profile.state_2'
        db.delete_column('profiles_profile', 'state_2')

        # Deleting field 'Profile.zipcode_2'
        db.delete_column('profiles_profile', 'zipcode_2')

        # Deleting field 'Profile.county_2'
        db.delete_column('profiles_profile', 'county_2')

        # Deleting field 'Profile.country_2'
        db.delete_column('profiles_profile', 'country_2')
