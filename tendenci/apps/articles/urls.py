...
urlpatterns = [
    ...
    re_path(r'^%s/feed/$' % urlpath, LatestEntriesFeed(), name='article.feed'),
    re_path(r'^%s/export/$' % urlpath, views.export, name='article.export'),
    ...
    re_path(r'^%s/reports/rank/$' % urlpath, views.articles_report, name='reports-articles'),
