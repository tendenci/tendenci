...
urlpatterns = patterns('tendenci.apps.articles.views',
    ...
    url(r'^%s/print-view/(?P<slug>[\w\-\/]+)/$' % urlpath, 'print_view', name="article.print_view"),
    url(r'^%s/add/$' % urlpath, 'add', name="article.add"),
    url(r'^%s/edit/(?P<id>\d+)/$' % urlpath, 'edit', name="article.edit"),
    url(r'^%s/edit/meta/(?P<id>\d+)/$' % urlpath, 'edit_meta', name="article.edit.meta"),
    url(r'^%s/delete/(?P<id>\d+)/$' % urlpath, 'delete', name="article.delete"),
