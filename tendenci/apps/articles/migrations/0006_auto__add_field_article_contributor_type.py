...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.contributor_type'
        db.add_column('articles_article', 'contributor_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.contributor_type'
        db.delete_column('articles_article', 'contributor_type')
