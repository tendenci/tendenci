...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Article.allow_anonymous_edit'
        db.delete_column('articles_article', 'allow_anonymous_edit')

        # Changing field 'Article.creator'
        db.alter_column('articles_article', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Article.owner'
        db.alter_column('articles_article', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))


    def backwards(self, orm):
        
        # Adding field 'Article.allow_anonymous_edit'
        db.add_column('articles_article', 'allow_anonymous_edit', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Article.creator'
        db.alter_column('articles_article', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Article.owner'
        db.alter_column('articles_article', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        'articles.article': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'articles_article_creator'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'articles_article_entity'", 'null': 'True', 'blank': 'True', 'to': "orm['entities.Entity']"}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'articles_article_owner'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 52, 32, 980180)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 52, 32, 980060)'}),
