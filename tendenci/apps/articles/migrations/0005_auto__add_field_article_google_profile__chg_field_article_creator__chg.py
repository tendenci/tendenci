...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.google_profile'
        db.add_column('articles_article', 'google_profile',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


        # Changing field 'Article.creator'
        db.alter_column('articles_article', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Article.entity'
        db.alter_column('articles_article', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['entities.Entity'], null=True))

        # Changing field 'Article.owner'
        db.alter_column('articles_article', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Article.group'
        db.alter_column('articles_article', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_groups.Group'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'Article.google_profile'
        db.delete_column('articles_article', 'google_profile')
        ...
        # Changing field 'Article.entity'
        db.alter_column('articles_article', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['entities.Entity']))

        # Changing field 'Article.owner'
        db.alter_column('articles_article', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Article.group'
        db.alter_column('articles_article', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_groups.Group'], null=True))
