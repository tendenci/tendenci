...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('articles_article', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='articles_article_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='articles_article_owner', to=orm['auth.User'])),
            ...
            ('not_official_content', self.gf('django.db.models.fields.BooleanField')(default=False)),
    ...
    models = {
        'articles.article': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'articles_article_creator'", 'to': "orm['auth.User']"}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'articles_article_owner'", 'to': "orm['auth.User']"}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 20, 30, 495637)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 15, 20, 30, 495550)'}),
