...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.allow_user_view'
        db.alter_column(u'articles_article', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Article.featured'
        db.alter_column(u'articles_article', 'featured', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Article.allow_anonymous_view'
        db.alter_column(u'articles_article', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Article.syndicate'
        db.alter_column(u'articles_article', 'syndicate', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Article.allow_user_edit'
        db.alter_column(u'articles_article', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Article.allow_member_view'
        db.alter_column(u'articles_article', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Article.allow_member_edit'
        db.alter_column(u'articles_article', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Article.status'
        db.alter_column(u'articles_article', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Article.not_official_content'
        db.alter_column(u'articles_article', 'not_official_content', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Article.allow_user_view'
        db.alter_column(u'articles_article', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Article.featured'
        db.alter_column(u'articles_article', 'featured', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Article.allow_anonymous_view'
        db.alter_column(u'articles_article', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Article.syndicate'
        db.alter_column(u'articles_article', 'syndicate', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Article.allow_user_edit'
        db.alter_column(u'articles_article', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Article.allow_member_view'
        db.alter_column(u'articles_article', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Article.allow_member_edit'
        db.alter_column(u'articles_article', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Article.status'
        db.alter_column(u'articles_article', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Article.not_official_content'
        db.alter_column(u'articles_article', 'not_official_content', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        u'articles.article': {
            ...
            'not_official_content': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
