    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_status', models.CharField(blank=True, max_length=50, verbose_name='Project Status', choices=[(b'open', b'Open'), (b'assigned', b'Assigned'), (b'in progress', b'In Progress'), (b'pending', b'Pending'), (b'closed', b'Closed')])),
