...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.project_fact_sheet_url'
        db.alter_column('projects_project', 'project_fact_sheet_url', self.gf('django.db.models.fields.URLField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Project.project_fact_sheet_url'
        db.alter_column('projects_project', 'project_fact_sheet_url', self.gf('django.db.models.fields.CharField')(max_length=200))
