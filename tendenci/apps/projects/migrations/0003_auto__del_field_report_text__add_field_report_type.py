...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Report.text'
        db.delete_column('projects_report', 'text')

        # Adding field 'Report.type'
        db.add_column('projects_report', 'type', self.gf('django.db.models.fields.CharField')(default='1', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Report.text'
        db.add_column('projects_report', 'text', self.gf('django.db.models.fields.CharField')(default='1', max_length=200), keep_default=False)

        # Deleting field 'Report.type'
        db.delete_column('projects_report', 'type')
