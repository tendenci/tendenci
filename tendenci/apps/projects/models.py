...
class Project(TendenciBaseModel):
    ...
    project_status = models.CharField(_('Project Status'),
        blank=True,
        max_length=50,
    ...
    city = models.CharField(
        _('City'), max_length=200, null = True, blank = True)
    state = models.CharField(_('State'), max_length=300, null = True,
        blank=True)
    start_dt = models.DateField(_('Project Start'), null=True, blank=True)
    end_dt = models.DateField(_('Project End'), null=True, blank=True)
    resolution = models.TextField(_('Resolution'), blank=True)
    project_description = models.TextField(_('Project Description'),
        blank=True)
    website_title = models.CharField(_('Project Website Title'),
        max_length=200, blank=True)
    website_url = models.URLField(_('Project Website URL'), max_length=200,
        blank=True)
    video_embed_code = models.TextField(_('Video Embed Code'),
        blank=True)
...
class Documents(File):
    ...
    other = models.CharField(_('other'), max_length=200, blank=True)
    document_dt = models.DateField(_('Document Date'), null=True, blank=True)
