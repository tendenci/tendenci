...
class Project(TendenciBaseModel):
    ...
    state = models.CharField(_('State'), max_length=300, null = True,
        blank=True)
    start_dt = models.DateField(_('Start Date'), null=True, blank=True)
    end_dt = models.DateField(_('End Date'), null=True, blank=True)
    resolution = models.TextField(_('Resolution'), blank=True)
    project_description = models.TextField(_('Description'),
        blank=True)
    website_title = models.CharField(_('Website Title'),
