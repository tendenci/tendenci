...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseDumpFile'
        db.create_table(u'explorer_extensions_databasedumpfile', (
        ...
        db.send_create_signal(u'explorer_extensions', ['DatabaseDumpFile'])


    def backwards(self, orm):
        # Deleting model 'DatabaseDumpFile'
        db.delete_table(u'explorer_extensions_databasedumpfile')
    ...
    models = {
        ...
        u'explorer_extensions.databasedumpfile': {
            'Meta': {'object_name': 'DatabaseDumpFile'},
    ...
    complete_apps = ['explorer_extensions']