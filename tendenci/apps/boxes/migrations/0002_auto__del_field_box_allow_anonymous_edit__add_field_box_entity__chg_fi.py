...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Box.allow_anonymous_edit'
        db.delete_column('boxes_box', 'allow_anonymous_edit')

        # Adding field 'Box.entity'
        db.add_column('boxes_box', 'entity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='boxes_box_entity', null=True, blank=True, to=orm['entities.Entity']), keep_default=False)

        # Changing field 'Box.creator'
        db.alter_column('boxes_box', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Box.owner'
        db.alter_column('boxes_box', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))


    def backwards(self, orm):
        
        # Adding field 'Box.allow_anonymous_edit'
        db.add_column('boxes_box', 'allow_anonymous_edit', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Box.entity'
        db.delete_column('boxes_box', 'entity_id')

        # Changing field 'Box.creator'
        db.alter_column('boxes_box', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Box.owner'
        db.alter_column('boxes_box', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 16, 11, 29, 248180)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 16, 11, 29, 248084)'}),
        ...
        'boxes.box': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'boxes_box_creator'", 'null': 'True', 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'boxes_box_entity'", 'null': 'True', 'blank': 'True', 'to': "orm['entities.Entity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'boxes_box_owner'", 'null': 'True', 'to': "orm['auth.User']"}),
