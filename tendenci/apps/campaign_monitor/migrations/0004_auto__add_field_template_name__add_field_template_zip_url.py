...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Template.name'
        db.add_column('campaign_monitor_template', 'name', self.gf('django.db.models.fields.CharField')(default='name', max_length=100), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Template.name'
        db.delete_column('campaign_monitor_template', 'name')
