...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('redirects_redirect', 'from_app', self.gf('django.db.models.fields.CharField')(db_index=True, default='', unique=True, max_length=100, blank=True), keep_default=False)
    ...
    models = {
        'redirects.redirect': {
            ...
            'from_app': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'unique': 'True', 'max_length': '100', 'blank': 'True'}),
