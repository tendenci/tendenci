...
from tendenci.apps.services.forms import ServiceForm
from tendenci.core.perms.object_perms import ObjectPermission
from tendenci.core.perms.utils import get_notice_recipients, get_query_filters, update_perms_and_save, has_perm, has_view_perm
...
def detail(request, slug=None, template_name="services/view.html"):
    ...
    if has_view_perm(request.user,'services.view_service',service):
        EventLog.objects.log(instance=service)
