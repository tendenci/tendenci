...
from tendenci.apps.architecture_projects.feeds import LatestEntriesFeed

urlpatterns = patterns('tendenci.apps.architecture_projects.views',
    url(r'^architecture-projects/$', 'detail', name="architecture_project"),
    ...
    url(r'^architecture-projects/(?P<slug>[\w\-]+)/$', 'detail', name="architecture_project.view"),
