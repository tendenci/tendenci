...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.security_key'
        db.add_column(u'newsletters_newsletter', 'security_key',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.security_key'
        db.delete_column(u'newsletters_newsletter', 'security_key')
