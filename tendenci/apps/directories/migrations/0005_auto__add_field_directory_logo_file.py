...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Directory.logo_file'
        db.add_column('directories_directory', 'logo_file',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['files.File'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Directory.logo_file'
        db.delete_column('directories_directory', 'logo_file_id')
