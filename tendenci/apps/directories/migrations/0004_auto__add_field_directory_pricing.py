...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Directory.pricing'
        db.add_column('directories_directory', 'pricing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directories.DirectoryPricing'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Directory.pricing'
        db.delete_column('directories_directory', 'pricing_id')
