...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Directory.renewal_notice_sent'
        db.add_column('directories_directory', 'renewal_notice_sent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Directory.renewal_notice_sent'
        db.delete_column('directories_directory', 'renewal_notice_sent')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 15, 57, 47, 387046)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 15, 57, 47, 386938)'}),
