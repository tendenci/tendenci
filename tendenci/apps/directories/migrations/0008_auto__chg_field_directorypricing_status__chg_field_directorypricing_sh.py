...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DirectoryPricing.status'
        db.alter_column(u'directories_directorypricing', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'DirectoryPricing.show_member_pricing'
        db.alter_column(u'directories_directorypricing', 'show_member_pricing', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Directory.allow_user_view'
        db.alter_column(u'directories_directory', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Directory.syndicate'
        db.alter_column(u'directories_directory', 'syndicate', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Directory.renewal_notice_sent'
        db.alter_column(u'directories_directory', 'renewal_notice_sent', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Directory.allow_user_edit'
        db.alter_column(u'directories_directory', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Directory.allow_member_view'
        db.alter_column(u'directories_directory', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Directory.status'
        db.alter_column(u'directories_directory', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Directory.allow_member_edit'
        db.alter_column(u'directories_directory', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Directory.allow_anonymous_view'
        db.alter_column(u'directories_directory', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'DirectoryPricing.status'
        db.alter_column(u'directories_directorypricing', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'DirectoryPricing.show_member_pricing'
        db.alter_column(u'directories_directorypricing', 'show_member_pricing', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Directory.allow_user_view'
        db.alter_column(u'directories_directory', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Directory.syndicate'
        db.alter_column(u'directories_directory', 'syndicate', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Directory.renewal_notice_sent'
        db.alter_column(u'directories_directory', 'renewal_notice_sent', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Directory.allow_user_edit'
        db.alter_column(u'directories_directory', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Directory.allow_member_view'
        db.alter_column(u'directories_directory', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Directory.status'
        db.alter_column(u'directories_directory', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Directory.allow_member_edit'
        db.alter_column(u'directories_directory', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Directory.allow_anonymous_view'
        db.alter_column(u'directories_directory', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())
