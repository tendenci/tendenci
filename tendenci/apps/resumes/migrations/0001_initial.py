...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('resumes_resume', (
            ...
            ('list_type', self.gf('django.db.models.fields.CharField')(default='regular', max_length=50)),
            ('requested_duration', self.gf('django.db.models.fields.IntegerField')(default=30)),
            ...
            ('resume_url', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ...
            ('contact_phone2', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resume_creator', null=True, to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resume_owner', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('resumes', ['Resume'])
