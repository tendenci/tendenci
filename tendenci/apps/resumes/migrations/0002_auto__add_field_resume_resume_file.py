...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Resume.resume_file'
        db.add_column('resumes_resume', 'resume_file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=260, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Resume.resume_file'
        db.delete_column('resumes_resume', 'resume_file')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 15, 23, 21, 59, 848846)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 15, 23, 21, 59, 848685)'}),
        ...
        'resumes.resume': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'resume_creator'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'resume_owner'", 'null': 'True', 'to': "orm['auth.User']"}),
