...
if "tendenci.apps.notifications" in settings.INSTALLED_APPS:
    ...
    def create_notice_types(app, verbosity, **kwargs):
        notification.create_notice_type("resume_added", _("Resume Added"), _("A resume has been added."), verbosity=verbosity)
        notification.create_notice_type("resume_deleted", _("Resume Deleted"), _("A resume has been deleted"), verbosity=verbosity)
