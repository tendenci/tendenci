...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.EmergencyAnnouncement.objects.exclude(enabled=True).update(enabled=False)

        # Fields from TendenciBaseModel
        orm.EmergencyAnnouncement.objects.exclude(allow_anonymous_view=True).update(allow_anonymous_view=False)
        orm.EmergencyAnnouncement.objects.exclude(allow_user_view=True).update(allow_user_view=False)
        orm.EmergencyAnnouncement.objects.exclude(allow_member_view=True).update(allow_member_view=False)
        orm.EmergencyAnnouncement.objects.exclude(allow_user_edit=True).update(allow_user_edit=False)
        orm.EmergencyAnnouncement.objects.exclude(allow_member_edit=True).update(allow_member_edit=False)
        orm.EmergencyAnnouncement.objects.exclude(status=True).update(status=False)
