...
def add_tendenci_footer(email_content, content_type='html'):
    """Add a promotional footer to outgoing email.
    ...
    if content_type == 'text':
        footer = (
            u'\n\n',
            _(u'This e-mail was generated by Tendenci® - The Open Source AMS') +
            u' https://www.tendenci.com')
        return email_content + footer
    else:
        footer = (
            u'<br /><br /><p align="center">' +
            _(u'This e-mail was generated by Tendenci® - The Open Source AMS') +
            u' <a href="https://www.tendenci.com">www.tendenci.com</a></p>')
        if email_content.endswith('</body>'):
            return email_content.replace(u'</body>', footer + u'\n</body>')
        else:
            return email_content + footer
