...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.ship_to_company'
        db.alter_column('invoices_invoice', 'ship_to_company', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Invoice.bill_to_address'
        db.alter_column('invoices_invoice', 'bill_to_address', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Invoice.ship_to_address'
        db.alter_column('invoices_invoice', 'ship_to_address', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Invoice.bill_to_company'
        db.alter_column('invoices_invoice', 'bill_to_company', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Invoice.ship_to_company'
        db.alter_column('invoices_invoice', 'ship_to_company', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Invoice.bill_to_address'
        db.alter_column('invoices_invoice', 'bill_to_address', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Invoice.ship_to_address'
        db.alter_column('invoices_invoice', 'ship_to_address', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Invoice.bill_to_company'
        db.alter_column('invoices_invoice', 'bill_to_company', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 26, 22, 29, 8, 205545)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 26, 22, 29, 8, 205443)'}),
