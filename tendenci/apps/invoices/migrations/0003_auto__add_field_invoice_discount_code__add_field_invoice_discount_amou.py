...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.discount_code'
        db.add_column('invoices_invoice', 'discount_code', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Invoice.discount_amount'
        db.add_column('invoices_invoice', 'discount_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoice.discount_code'
        db.delete_column('invoices_invoice', 'discount_code')

        # Deleting field 'Invoice.discount_amount'
        db.delete_column('invoices_invoice', 'discount_amount')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 15, 8, 9, 45, 606847)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 15, 8, 9, 45, 606747)'}),
