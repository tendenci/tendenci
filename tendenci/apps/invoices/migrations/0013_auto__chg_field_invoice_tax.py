...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.tax'
        db.alter_column(u'invoices_invoice', 'tax', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'Invoice.tax'
        db.alter_column(u'invoices_invoice', 'tax', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=4))
    ...
    models = {
        ...
        u'invoices.invoice': {
            ...
            'tax': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '15', 'decimal_places': '4'}),
