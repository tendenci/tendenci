...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Invoice.estimate'
        db.delete_column('invoices_invoice', 'estimate')

        # Adding field 'Invoice.is_void'
        db.add_column('invoices_invoice', 'is_void',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Invoice.estimate'
        db.add_column('invoices_invoice', 'estimate',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Invoice.is_void'
        db.delete_column('invoices_invoice', 'is_void')
