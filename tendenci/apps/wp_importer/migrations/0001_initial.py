...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlogImport'
        db.create_table(u'wp_importer_blogimport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('blog_import_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('blog', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'wp_importer', ['BlogImport'])

        # Adding model 'AssociatedFile'
        db.create_table(u'wp_importer_associatedfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'wp_importer', ['AssociatedFile'])


    def backwards(self, orm):
        # Deleting model 'BlogImport'
        db.delete_table(u'wp_importer_blogimport')

        # Deleting model 'AssociatedFile'
        db.delete_table(u'wp_importer_associatedfile')
    ...
    models = {
        ...
        u'wp_importer.associatedfile': {
            'Meta': {'object_name': 'AssociatedFile'},
            'file': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['files.File']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post_id': ('django.db.models.fields.IntegerField', [], {})
        },
        u'wp_importer.blogimport': {
            'Meta': {'object_name': 'BlogImport'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'blog': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'blog_import_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }

    complete_apps = ['wp_importer']