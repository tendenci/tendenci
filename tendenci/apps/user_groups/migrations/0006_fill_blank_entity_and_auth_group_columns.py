...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # trap db errors so migrations can continue
        try:
            groups = orm['user_groups.Group'].objects.all()
            if groups:
                first_entity = orm['entities.entity'].objects.first()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 31, 12, 19, 52, 413773)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 31, 12, 19, 52, 413671)'}),
