...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.dashboard_url'
        db.add_column('user_groups_group', 'dashboard_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.dashboard_url'
        db.delete_column('user_groups_group', 'dashboard_url')
