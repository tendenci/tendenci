...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('user_groups_groupmembership', 'is_newsletter_subscribed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'GroupMembership.newsletter_key'
        db.add_column('user_groups_groupmembership', 'newsletter_key',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('user_groups_groupmembership', 'is_newsletter_subscribed')

        # Deleting field 'GroupMembership.newsletter_key'
        db.delete_column('user_groups_groupmembership', 'newsletter_key')
