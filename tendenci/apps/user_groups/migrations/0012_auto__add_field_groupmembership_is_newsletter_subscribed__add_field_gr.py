...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupMembership.is_newsletter_subscribed'
        db.add_column(u'user_groups_groupmembership', 'is_newsletter_subscribed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'GroupMembership.newsletter_key'
        db.add_column(u'user_groups_groupmembership', 'newsletter_key',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupMembership.is_newsletter_subscribed'
        db.delete_column(u'user_groups_groupmembership', 'is_newsletter_subscribed')

        # Deleting field 'GroupMembership.newsletter_key'
        db.delete_column(u'user_groups_groupmembership', 'newsletter_key')
