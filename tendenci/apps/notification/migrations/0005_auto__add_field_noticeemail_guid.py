...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('notification_noticeemail', 'guid', self.gf('django.db.models.fields.CharField')(default='1111', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NoticeEmail.guid'
        db.delete_column('notification_noticeemail', 'guid')
