...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Email.status'
        db.alter_column(u'emails_email', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Email.creator'
        db.alter_column(u'emails_email', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Email.allow_user_view'
        db.alter_column(u'emails_email', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Email.entity'
        db.alter_column(u'emails_email', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['entities.Entity'], null=True))

        # Changing field 'Email.owner'
        db.alter_column(u'emails_email', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Email.allow_anonymous_view'
        db.alter_column(u'emails_email', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Email.allow_user_edit'
        db.alter_column(u'emails_email', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Email.allow_member_view'
        db.alter_column(u'emails_email', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Email.allow_member_edit'
        db.alter_column(u'emails_email', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Email.status'
        db.alter_column(u'emails_email', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Email.creator'
        db.alter_column(u'emails_email', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Email.allow_user_view'
        db.alter_column(u'emails_email', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Email.entity'
        db.alter_column(u'emails_email', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['entities.Entity']))

        # Changing field 'Email.owner'
        db.alter_column(u'emails_email', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Email.allow_anonymous_view'
        db.alter_column(u'emails_email', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Email.allow_user_edit'
        db.alter_column(u'emails_email', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Email.allow_member_view'
        db.alter_column(u'emails_email', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Email.allow_member_edit'
        db.alter_column(u'emails_email', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())
