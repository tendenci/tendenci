    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.CharField(default=b'', max_length=255, blank=True)),
                ('recipient_dispaly', models.CharField(default=b'', max_length=255, blank=True)),
                ('recipient_cc', models.CharField(default=b'', max_length=255, blank=True)),
                ('recipient_cc_display', models.CharField(default=b'', max_length=255, blank=True)),
                ('recipient_bcc', models.CharField(default=b'', max_length=255, blank=True)),
                ('attachments', models.CharField(default=b'', max_length=500, blank=True)),
                ('content_type', models.CharField(default=b'text/html', max_length=255, choices=[(b'text/html', b'text/html'), (b'text', b'text')])),
