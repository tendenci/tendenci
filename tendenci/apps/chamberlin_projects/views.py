...
from tendenci.apps.chamberlin_projects.models import Project, ConstructionCategory
from tendenci.core.site_settings.utils import get_setting
from tendenci.core.perms.utils import get_notice_recipients, get_query_filters, has_view_perm
