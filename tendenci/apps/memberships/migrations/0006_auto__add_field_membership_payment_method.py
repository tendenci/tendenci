...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membership.payment_method'
        db.add_column('memberships_membership', 'payment_method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.PaymentMethod'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Membership.payment_method'
        db.delete_column('memberships_membership', 'payment_method_id')
