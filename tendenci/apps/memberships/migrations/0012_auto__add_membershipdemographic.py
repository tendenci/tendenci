...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MembershipDemographic'
        db.create_table('memberships_membershipdemographic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='demographics', unique=True, to=orm['auth.User'])),
            ('ud1', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud2', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud3', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud4', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud5', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud6', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud7', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud8', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud9', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud10', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud11', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud12', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud13', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud14', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud15', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud16', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud17', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud18', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud19', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud20', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud21', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud22', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud23', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud24', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud25', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud26', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud27', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud28', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud29', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('ud30', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal('memberships', ['MembershipDemographic'])


    def backwards(self, orm):
        
        # Deleting model 'MembershipDemographic'
        db.delete_table('memberships_membershipdemographic')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 17, 34, 37, 333800)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 17, 34, 37, 333597)'}),
