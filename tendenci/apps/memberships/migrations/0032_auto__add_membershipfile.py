...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MembershipFile'
        db.create_table('memberships_membershipfile', (
            ('file_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['files.File'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('memberships', ['MembershipFile'])


    def backwards(self, orm):
        # Deleting model 'MembershipFile'
        db.delete_table('memberships_membershipfile')
