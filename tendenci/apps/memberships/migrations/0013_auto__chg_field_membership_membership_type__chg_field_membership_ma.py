...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('memberships_membership', 'membership_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['memberships.MembershipType'], null=True))

        # Changing field 'Membership.ma'
        db.alter_column('memberships_membership', 'ma_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['memberships.App'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Membership.membership_type'
        db.alter_column('memberships_membership', 'membership_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['memberships.MembershipType']))

        # Changing field 'Membership.ma'
        db.alter_column('memberships_membership', 'ma_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['memberships.App']))
    ...
    models = {
        ...
        'memberships.membership': {
            ...
            'membership_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['memberships.MembershipType']", 'null': 'True'}),
