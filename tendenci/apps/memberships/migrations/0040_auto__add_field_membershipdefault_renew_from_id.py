...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MembershipDefault.renew_from_id'
        db.add_column(u'memberships_membershipdefault', 'renew_from_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MembershipDefault.renew_from_id'
        db.delete_column(u'memberships_membershipdefault', 'renew_from_id')
    ...
    models = {
        ...
        u'memberships.membershipdefault': {
            ...
            'renew_from_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
