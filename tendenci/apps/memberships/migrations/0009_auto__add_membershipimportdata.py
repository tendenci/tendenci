...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MembershipImportData'
        db.create_table('memberships_membershipimportdata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mimport', self.gf('django.db.models.fields.related.ForeignKey')(related_name='membership_import_data', to=orm['memberships.MembershipImport'])),
        ...
        db.send_create_signal('memberships', ['MembershipImportData'])


    def backwards(self, orm):
        
        # Deleting model 'MembershipImportData'
        db.delete_table('memberships_membershipimportdata')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 16, 15, 51, 51, 755761)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 16, 15, 51, 51, 755648)'}),
