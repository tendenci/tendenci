...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AppEntry.hash'
        db.add_column('memberships_appentry', 'hash', self.gf('django.db.models.fields.CharField')(default='', max_length=40, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AppEntry.hash'
        db.delete_column('memberships_appentry', 'hash')
