...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field groups on 'MembershipDefault'
        db.create_table('memberships_membershipdefault_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('membershipdefault', models.ForeignKey(orm['memberships.membershipdefault'], null=False)),
            ('group', models.ForeignKey(orm['user_groups.group'], null=False))
        ))
        db.create_unique('memberships_membershipdefault_groups', ['membershipdefault_id', 'group_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field groups on 'MembershipDefault'
        db.delete_table('memberships_membershipdefault_groups')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 19, 17, 4, 43, 220675)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 19, 17, 4, 43, 220569)'}),
