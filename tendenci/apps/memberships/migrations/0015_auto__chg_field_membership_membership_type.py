...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('memberships_membership', 'membership_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['memberships.MembershipType']))
