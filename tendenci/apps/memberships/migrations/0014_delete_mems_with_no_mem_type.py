...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Delete all memberships without a Membership Type
        so we can correct the database and memberships created via the profile
        """
        orm.Membership.objects.filter(membership_type=None).delete()


    def backwards(self, orm):
        """This is a correction migration
        skipping backwards migration
        """
        pass
