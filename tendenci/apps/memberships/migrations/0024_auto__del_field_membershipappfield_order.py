...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MembershipAppField.order'
        db.delete_column('memberships_membershipappfield', 'order')


    def backwards(self, orm):
        
        # Adding field 'MembershipAppField.order'
        db.add_column('memberships_membershipappfield', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 15, 5, 1, 652553)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 15, 5, 1, 652376)'}),
