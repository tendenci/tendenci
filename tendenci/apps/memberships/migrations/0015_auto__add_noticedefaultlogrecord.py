...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NoticeDefaultLogRecord'
        db.create_table('memberships_noticedefaultlogrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('guid', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('notice_log', self.gf('django.db.models.fields.related.ForeignKey')(related_name='default_log_records', to=orm['memberships.NoticeLog'])),
            ('membership', self.gf('django.db.models.fields.related.ForeignKey')(related_name='default_log_records', to=orm['memberships.MembershipDefault'])),
        ...
        db.send_create_signal('memberships', ['NoticeDefaultLogRecord'])


    def backwards(self, orm):
        
        # Deleting model 'NoticeDefaultLogRecord'
        db.delete_table('memberships_noticedefaultlogrecord')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 15, 13, 41, 764794)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 15, 13, 41, 764674)'}),
