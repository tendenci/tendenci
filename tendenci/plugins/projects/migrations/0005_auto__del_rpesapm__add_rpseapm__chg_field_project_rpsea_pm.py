...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RpseaPm'
        db.create_table('projects_rpseapm', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('projects', ['RpseaPm'])

        # Changing field 'Project.rpsea_pm'
        db.alter_column('projects_project', 'rpsea_pm_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.RpseaPm'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'RpseaPm'
        db.delete_table('projects_rpseapm')

        # Changing field 'Project.rpsea_pm'
        db.alter_column('projects_project', 'rpsea_pm_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.RpesaPm'], null=True))
    ...
    models = {
        ...
        'projects.project': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.Program']", 'null': 'True', 'blank': 'True'}),
            ...
            'project_fact_sheet_url': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            ...
            'rpsea_pm': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.RpseaPm']", 'null': 'True', 'blank': 'True'}),
