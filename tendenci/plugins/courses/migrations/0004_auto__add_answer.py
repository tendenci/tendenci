...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Answer'
        db.create_table('courses_answer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='answers', to=orm['courses.Question'])),
        ...
        db.send_create_signal('courses', ['Answer'])


    def backwards(self, orm):
        
        # Deleting model 'Answer'
        db.delete_table('courses_answer')
