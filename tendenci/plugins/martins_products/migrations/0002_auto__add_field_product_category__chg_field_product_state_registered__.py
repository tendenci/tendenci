...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('martins_products_product', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['martins_products.Category'], null=True, blank=True), keep_default=False)

        # Changing field 'Product.state_registered'
        db.alter_column('martins_products_product', 'state_registered', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Product.product_label'
        db.alter_column('martins_products_product', 'product_label', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Product.msds_label'
        db.alter_column('martins_products_product', 'msds_label', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Deleting field 'Product.category'
        db.delete_column('martins_products_product', 'category_id')

        # Changing field 'Product.state_registered'
        db.alter_column('martins_products_product', 'state_registered', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Product.product_label'
        db.alter_column('martins_products_product', 'product_label', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Product.msds_label'
        db.alter_column('martins_products_product', 'msds_label', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'martins_products.product': {
            ...
            'active_ingredients': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'allow_anonymous_edit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_anonymous_view': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'allow_member_edit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_member_view': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_user_edit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_user_view': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'brand': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['martins_products.Category']", 'null': 'True', 'blank': 'True'}),
            ...
            'generic_description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key_insects': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'msds_label': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product_owner'", 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'product_code': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'product_features': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'product_id': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'product_image': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['martins_products.ProductPhoto']", 'null': 'True', 'blank': 'True'}),
            'product_label': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            ...
            'product_specs': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'state_registered': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
            'tags': ('tagging.fields.TagField', [], {}),
            'update_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'use_sites': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
        },
