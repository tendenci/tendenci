...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HoverPhoto'
        db.create_table('martins_products_hoverphoto', (
            ('file_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['files.File'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('martins_products', ['HoverPhoto'])

        # Adding field 'Product.hover_image'
        db.add_column('martins_products_product', 'hover_image', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['martins_products.HoverPhoto'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'HoverPhoto'
        db.delete_table('martins_products_hoverphoto')

        # Deleting field 'Product.hover_image'
        db.delete_column('martins_products_product', 'hover_image_id')
    ...
    models = {
        ...
        'martins_products.hoverphoto': {
            'Meta': {'object_name': 'HoverPhoto', '_ormbases': ['files.File']},
        ...
        'martins_products.product': {
            ...
            'category_num': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'hover_image': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['martins_products.HoverPhoto']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
