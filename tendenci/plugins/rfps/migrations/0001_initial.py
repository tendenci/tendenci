...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rfps_program', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ))
        db.send_create_signal('rfps', ['Program'])

        # Adding model 'RFP'
        db.create_table('rfps_rfp', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rfp_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rfp_owner', to=orm['auth.User'])),
            ...
            ('program', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rfps.Program'], null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('rfp_status', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('release_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('proposal_due_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('expired_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('rfp_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('rfp_file_close', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('questions_title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('questions_expiration_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('contract_doc', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('contract_doc_description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('rfps', ['RFP'])


    def backwards(self, orm):
        
        # Deleting model 'Program'
        db.delete_table('rfps_program')

        # Deleting model 'RFP'
        db.delete_table('rfps_rfp')
    ...
    models = {
        ...
        'rfps.rfp': {
            ...
            'allow_user_edit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_user_view': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'contract_doc': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'contract_doc_description': ('django.db.models.fields.TextField', [], {}),
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rfp_creator'", 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'expired_dt': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rfp_owner'", 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rfps.Program']", 'null': 'True', 'blank': 'True'}),
            'proposal_due_dt': ('django.db.models.fields.DateTimeField', [], {}),
            'questions_expiration_dt': ('django.db.models.fields.DateTimeField', [], {}),
            'questions_title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'release_dt': ('django.db.models.fields.DateTimeField', [], {}),
            'rfp_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'rfp_file_close': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'rfp_status': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
