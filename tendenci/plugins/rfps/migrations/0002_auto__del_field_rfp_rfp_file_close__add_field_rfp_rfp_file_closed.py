...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RFP.rfp_file_close'
        db.delete_column('rfps_rfp', 'rfp_file_close')

        # Adding field 'RFP.rfp_file_closed'
        db.add_column('rfps_rfp', 'rfp_file_closed', self.gf('django.db.models.fields.files.FileField')(default='2', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RFP.rfp_file_close'
        db.add_column('rfps_rfp', 'rfp_file_close', self.gf('django.db.models.fields.files.FileField')(default='1', max_length=100), keep_default=False)

        # Deleting field 'RFP.rfp_file_closed'
        db.delete_column('rfps_rfp', 'rfp_file_closed')
    ...
    models = {
        ...
        'rfps.rfp': {
            ...
            'rfp_file_closed': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
