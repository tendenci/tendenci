...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FilesCategory'
        db.create_table('files_filescategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['files.FilesCategory'], null=True)),
        ))
        db.send_create_signal('files', ['FilesCategory'])

        # Adding field 'File.file_cat'
        db.add_column('files_file', 'file_cat',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='file_cat', null=True, on_delete=models.SET_NULL, to=orm['files.FilesCategory']),
                      keep_default=False)

        # Adding field 'File.file_sub_cat'
        db.add_column('files_file', 'file_sub_cat',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='file_subcat', null=True, on_delete=models.SET_NULL, to=orm['files.FilesCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FilesCategory'
        db.delete_table('files_filescategory')

        # Deleting field 'File.file_cat'
        db.delete_column('files_file', 'file_cat_id')

        # Deleting field 'File.file_sub_cat'
        db.delete_column('files_file', 'file_sub_cat_id')
    ...
    models = {
        ...
        'files.file': {
            ...
            'file_cat': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'file_cat'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['files.FilesCategory']"}),
            'file_sub_cat': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'file_subcat'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['files.FilesCategory']"}),
        ...
        'files.filescategory': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['files.FilesCategory']", 'null': 'True'})
        },
        'files.multiplefile': {
