...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('files_file', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'File.name'
        db.alter_column('files_file', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))
