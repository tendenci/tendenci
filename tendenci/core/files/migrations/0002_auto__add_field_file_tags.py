...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('files_file', 'tags', self.gf('tagging.fields.TagField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'File.tags'
        db.delete_column('files_file', 'tags')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 21, 17, 10, 23, 912297)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 21, 17, 10, 23, 912161)'}),
