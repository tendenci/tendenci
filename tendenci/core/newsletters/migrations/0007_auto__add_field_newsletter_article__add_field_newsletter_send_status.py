...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.article'
        db.add_column('newsletters_newsletter', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.Article'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Newsletter.send_status'
        db.add_column('newsletters_newsletter', 'send_status',
                      self.gf('django.db.models.fields.CharField')(default='draft', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.article'
        db.delete_column('newsletters_newsletter', 'article_id')

        # Deleting field 'Newsletter.send_status'
        db.delete_column('newsletters_newsletter', 'send_status')
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'event_end_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 18, 0, 0)'}),
            'event_start_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 20, 0, 0)'}),
