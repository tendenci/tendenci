...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('newsletters_newsletter', 'security_key',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('newsletters_newsletter', 'security_key')
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'event_end_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 22, 0, 0)'}),
            'event_start_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 24, 0, 0)'}),
