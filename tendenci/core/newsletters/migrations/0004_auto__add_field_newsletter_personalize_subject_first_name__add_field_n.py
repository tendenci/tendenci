...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.personalize_subject_first_name'
        db.add_column('newsletters_newsletter', 'personalize_subject_first_name',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Newsletter.personalize_subject_last_name'
        db.add_column('newsletters_newsletter', 'personalize_subject_last_name',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Newsletter.default_template'
        db.add_column('newsletters_newsletter', 'default_template',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.personalize_subject_first_name'
        db.delete_column('newsletters_newsletter', 'personalize_subject_first_name')

        # Deleting field 'Newsletter.personalize_subject_last_name'
        db.delete_column('newsletters_newsletter', 'personalize_subject_last_name')

        # Deleting field 'Newsletter.default_template'
        db.delete_column('newsletters_newsletter', 'default_template')
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'default_template': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'event_end_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 10, 0, 0)'}),
            'event_start_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 12, 0, 0)'}),
