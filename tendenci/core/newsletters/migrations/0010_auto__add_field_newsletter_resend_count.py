...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.resend_count'
        db.add_column('newsletters_newsletter', 'resend_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.resend_count'
        db.delete_column('newsletters_newsletter', 'resend_count')
