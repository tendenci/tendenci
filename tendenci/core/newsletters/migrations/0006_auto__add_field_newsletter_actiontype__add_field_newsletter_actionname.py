...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.actiontype'
        db.add_column('newsletters_newsletter', 'actiontype',
                      self.gf('django.db.models.fields.CharField')(default='Distribution E-mail', max_length=30),
                      keep_default=False)

        # Adding field 'Newsletter.actionname'
        db.add_column('newsletters_newsletter', 'actionname',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Newsletter.sla'
        db.add_column('newsletters_newsletter', 'sla',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.actiontype'
        db.delete_column('newsletters_newsletter', 'actiontype')

        # Deleting field 'Newsletter.actionname'
        db.delete_column('newsletters_newsletter', 'actionname')

        # Deleting field 'Newsletter.sla'
        db.delete_column('newsletters_newsletter', 'sla')
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'event_end_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 17, 0, 0)'}),
            'event_start_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 19, 0, 0)'}),
