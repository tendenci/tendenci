...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.date_last_resent'
        db.add_column('newsletters_newsletter', 'date_last_resent',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.date_last_resent'
        db.delete_column('newsletters_newsletter', 'date_last_resent')
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'event_end_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 1, 0, 0)'}),
            'event_start_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 12, 1, 0, 0)'}),
