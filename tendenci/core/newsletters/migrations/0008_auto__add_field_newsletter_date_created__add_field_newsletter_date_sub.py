...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.date_created'
        db.add_column('newsletters_newsletter', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Newsletter.date_submitted'
        db.add_column('newsletters_newsletter', 'date_submitted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Newsletter.date_email_sent'
        db.add_column('newsletters_newsletter', 'date_email_sent',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Newsletter.email_sent_count'
        db.add_column('newsletters_newsletter', 'email_sent_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.date_created'
        db.delete_column('newsletters_newsletter', 'date_created')

        # Deleting field 'Newsletter.date_submitted'
        db.delete_column('newsletters_newsletter', 'date_submitted')

        # Deleting field 'Newsletter.date_email_sent'
        db.delete_column('newsletters_newsletter', 'date_email_sent')

        # Deleting field 'Newsletter.email_sent_count'
        db.delete_column('newsletters_newsletter', 'email_sent_count')
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'event_end_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 23, 0, 0)'}),
            'event_start_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 25, 0, 0)'}),
