...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Newsletter.content'
        db.delete_column('newsletters_newsletter', 'content')

        # Adding field 'Newsletter.email'
        db.add_column('newsletters_newsletter', 'email',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emails.Email'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Newsletter.content'
        db.add_column('newsletters_newsletter', 'content',
                      self.gf('tinymce.models.HTMLField')(default=''),
                      keep_default=False)

        # Deleting field 'Newsletter.email'
        db.delete_column('newsletters_newsletter', 'email_id')
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'event_end_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 16, 0, 0)'}),
            'event_start_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 18, 0, 0)'}),
