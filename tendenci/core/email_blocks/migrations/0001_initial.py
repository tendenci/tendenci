...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EmailBlock'
        db.create_table('email_blocks_emailblock', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='emailblock_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='emailblock_owner', to=orm['auth.User'])),
        ...
        db.send_create_signal('email_blocks', ['EmailBlock'])


    def backwards(self, orm):
        
        # Deleting model 'EmailBlock'
        db.delete_table('email_blocks_emailblock')
    ...
    models = {
        ...
        'email_blocks.emailblock': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'emailblock_creator'", 'to': "orm['auth.User']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'emailblock_owner'", 'to': "orm['auth.User']"}),
