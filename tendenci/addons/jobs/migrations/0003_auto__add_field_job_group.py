...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('jobs_job', 'group', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.Group'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.group'
        db.delete_column('jobs_job', 'group_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 11, 42, 28, 573215)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 11, 42, 28, 573119)'}),
