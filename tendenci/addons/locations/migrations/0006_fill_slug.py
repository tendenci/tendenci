...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for row in Location.objects.all():
            ...
            test_slug = slug
            while Location.objects.exclude(pk=row.pk).filter(slug=test_slug).count():
                test_slug = u'{}-{}'.format(slug, index)
                index += 1
    ...
    models = {
        ...
        'entities.entity': {
            ...
            'email': ('django.db.models.fields.CharField', [], {'max_length': '254', 'blank': 'True'}),
