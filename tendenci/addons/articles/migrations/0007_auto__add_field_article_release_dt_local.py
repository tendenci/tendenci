...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.release_dt_local'
        db.add_column('articles_article', 'release_dt_local',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.release_dt_local'
        db.delete_column('articles_article', 'release_dt_local')
