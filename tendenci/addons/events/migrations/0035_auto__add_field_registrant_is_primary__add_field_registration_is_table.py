...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Registrant.is_primary'
        db.add_column('events_registrant', 'is_primary', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Registration.is_table'
        db.add_column('events_registration', 'is_table', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Registration.quantity'
        db.add_column('events_registration', 'quantity', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Registrant.is_primary'
        db.delete_column('events_registrant', 'is_primary')

        # Deleting field 'Registration.is_table'
        db.delete_column('events_registration', 'is_table')

        # Deleting field 'Registration.quantity'
        db.delete_column('events_registration', 'quantity')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 6, 12, 36, 14, 195106)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 6, 10, 36, 14, 195068)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 6, 16, 36, 14, 186663)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 6, 10, 36, 14, 186621)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
