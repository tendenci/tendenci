...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Registrant.override'
        db.add_column('events_registrant', 'override', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Registrant.override_price'
        db.add_column('events_registrant', 'override_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'Registration.override_table'
        db.add_column('events_registration', 'override_table', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Registration.override_price_table'
        db.add_column('events_registration', 'override_price_table', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Registrant.override'
        db.delete_column('events_registrant', 'override')

        # Deleting field 'Registrant.override_price'
        db.delete_column('events_registrant', 'override_price')

        # Deleting field 'Registration.override_table'
        db.delete_column('events_registration', 'override_table')

        # Deleting field 'Registration.override_price_table'
        db.delete_column('events_registration', 'override_price_table')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 7, 12, 36, 28, 6787)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 7, 10, 36, 28, 6751)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 7, 16, 36, 27, 998248)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 7, 10, 36, 27, 998217)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'events.registrationconfiguration': {
            ...
            'honor_system': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
