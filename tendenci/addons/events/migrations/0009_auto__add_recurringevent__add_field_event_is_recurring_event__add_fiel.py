...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_recurringevent', (
            ...
            ('starts_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 25, 2, 29, 42, 176718))),
        ...
        db.add_column('events_event', 'is_recurring_event', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.recurring_event'
        db.add_column('events_event', 'recurring_event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.RecurringEvent'], null=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 2, 29, 43, 927925)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 2, 29, 43, 927823)'}),
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 25, 4, 29, 42, 178154)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 25, 2, 29, 42, 178050)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.recurringevent': {
            ...
            'starts_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 25, 2, 29, 42, 176718)'})
        },
        'events.regaddon': {
        ...
        'events.regconfpricing': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 25, 8, 29, 42, 163170)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 2, 29, 42, 163112)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
