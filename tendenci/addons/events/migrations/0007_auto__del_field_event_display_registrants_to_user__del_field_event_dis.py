...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.display_registrants_to_user'
        db.delete_column('events_event', 'display_registrants_to_user')

        # Deleting field 'Event.display_registrants_to_public'
        db.delete_column('events_event', 'display_registrants_to_public')

        # Deleting field 'Event.display_registrants_to_admin'
        db.delete_column('events_event', 'display_registrants_to_admin')

        # Deleting field 'Event.display_registrants_to_member'
        db.delete_column('events_event', 'display_registrants_to_member')

        # Adding field 'Event.display_registrants_to'
        db.add_column('events_event', 'display_registrants_to', self.gf('django.db.models.fields.CharField')(default='public', max_length=6), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Event.display_registrants_to_user'
        db.add_column('events_event', 'display_registrants_to_user', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.display_registrants_to_public'
        db.add_column('events_event', 'display_registrants_to_public', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.display_registrants_to_admin'
        db.add_column('events_event', 'display_registrants_to_admin', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.display_registrants_to_member'
        db.add_column('events_event', 'display_registrants_to_member', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Event.display_registrants_to'
        db.delete_column('events_event', 'display_registrants_to')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 6, 6, 17, 40, 537942)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 6, 6, 17, 40, 537838)'}),
        ...
        'events.event': {
            ...
            'allow_user_view': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'events_event_creator'", 'null': 'True', 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'display_event_registrants': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'display_registrants_to': ('django.db.models.fields.CharField', [], {'default': "'public'", 'max_length': '6'}),
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 5, 8, 17, 39, 823802)'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'events_event_owner'", 'null': 'True', 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 5, 6, 17, 39, 823747)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 5, 12, 17, 39, 813793)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 6, 6, 17, 39, 813761)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
