...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomRegForm.first_name'
        db.add_column('events_customregform', 'first_name', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.last_name'
        db.add_column('events_customregform', 'last_name', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.mail_name'
        db.add_column('events_customregform', 'mail_name', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.address'
        db.add_column('events_customregform', 'address', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.city'
        db.add_column('events_customregform', 'city', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.state'
        db.add_column('events_customregform', 'state', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.zip'
        db.add_column('events_customregform', 'zip', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.country'
        db.add_column('events_customregform', 'country', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.phone'
        db.add_column('events_customregform', 'phone', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.email'
        db.add_column('events_customregform', 'email', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.position_title'
        db.add_column('events_customregform', 'position_title', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.company_name'
        db.add_column('events_customregform', 'company_name', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.meal_option'
        db.add_column('events_customregform', 'meal_option', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CustomRegForm.comments'
        db.add_column('events_customregform', 'comments', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomRegForm.first_name'
        db.delete_column('events_customregform', 'first_name')

        # Deleting field 'CustomRegForm.last_name'
        db.delete_column('events_customregform', 'last_name')

        # Deleting field 'CustomRegForm.mail_name'
        db.delete_column('events_customregform', 'mail_name')

        # Deleting field 'CustomRegForm.address'
        db.delete_column('events_customregform', 'address')

        # Deleting field 'CustomRegForm.city'
        db.delete_column('events_customregform', 'city')

        # Deleting field 'CustomRegForm.state'
        db.delete_column('events_customregform', 'state')

        # Deleting field 'CustomRegForm.zip'
        db.delete_column('events_customregform', 'zip')

        # Deleting field 'CustomRegForm.country'
        db.delete_column('events_customregform', 'country')

        # Deleting field 'CustomRegForm.phone'
        db.delete_column('events_customregform', 'phone')

        # Deleting field 'CustomRegForm.email'
        db.delete_column('events_customregform', 'email')

        # Deleting field 'CustomRegForm.position_title'
        db.delete_column('events_customregform', 'position_title')

        # Deleting field 'CustomRegForm.company_name'
        db.delete_column('events_customregform', 'company_name')

        # Deleting field 'CustomRegForm.meal_option'
        db.delete_column('events_customregform', 'meal_option')

        # Deleting field 'CustomRegForm.comments'
        db.delete_column('events_customregform', 'comments')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 12, 12, 5, 41, 146267)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 12, 10, 5, 41, 146230)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 12, 16, 5, 41, 137692)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 10, 5, 41, 137660)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
