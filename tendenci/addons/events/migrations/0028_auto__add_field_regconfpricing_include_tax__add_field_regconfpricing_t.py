...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegConfPricing.include_tax'
        db.add_column('events_regconfpricing', 'include_tax',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RegConfPricing.tax_rate'
        db.add_column('events_regconfpricing', 'tax_rate',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('events_regconfpricing', 'include_tax')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 13, 0, 0)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 13, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.recurringevent': {
            ...
            'starts_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 13, 0, 0)'})
        },
        'events.regaddon': {
        ...
        'events.regconfpricing': {
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 13, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
