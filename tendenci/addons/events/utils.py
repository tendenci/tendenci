...
def event_update_util(request, form_event, params):
    event = params['event']
    place = params['place']
    regconf = params['regconf']
    speakers = params['speakers']
    organizer = params['organizer']
    regconf_pricing = params['regconf_pricing']
    conf_reg_form_required = params['conf_reg_form_required']
    pricing_reg_form_required = params['pricing_reg_form_required']

    if 'add_mode' in params.keys():
...
def handle_recurring_event_edit(request, event, params, form_class=EventForm):
    ...
    if all([form.is_valid() for form in forms]):
        ...
        params = {}
        params['place'] = form_place.save()
        params['regconf'] = form_regconf.save()
        params['speakers'] = form_speaker.save()
        params['organizer'] = form_organizer.save()
        params['regconf_pricing'] = form_regconfpricing.save()
        params['conf_reg_form_required'] = conf_reg_form_required
        params['pricing_reg_form_required'] = pricing_reg_form_required
