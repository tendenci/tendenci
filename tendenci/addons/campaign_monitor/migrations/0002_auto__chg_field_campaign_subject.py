...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('campaign_monitor_campaign', 'subject', self.gf('django.db.models.fields.CharField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'Campaign.subject'
        db.alter_column('campaign_monitor_campaign', 'subject', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 11, 16, 11, 8, 128374)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 11, 16, 11, 8, 128256)'}),
