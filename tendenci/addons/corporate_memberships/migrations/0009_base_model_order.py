...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for mem in orm.CorporateMembershipType.objects.all():
            mem.position = mem.order
            mem.save()

        for field in orm.CorpField.objects.all():
            field.position = field.order
            field.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 14, 57, 52, 138269)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 14, 57, 52, 138174)'}),
