...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FreePassesStat'
        db.create_table('corporate_memberships_freepassesstat', (
            ...
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='corporate_memberships_freepassesstat_entity', on_delete=models.SET_NULL, default=None, to=orm['entities.Entity'], blank=True, null=True)),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='corporate_memberships_freepassesstat_creator', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='corporate_memberships_freepassesstat_owner', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ...
            ('corp_membership', self.gf('django.db.models.fields.related.ForeignKey')(related_name='passes_used', to=orm['corporate_memberships.CorpMembership'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='passes_used', to=orm['events.Event'])),
            ('registrant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Registrant'], null=True)),
        ))
        db.send_create_signal('corporate_memberships', ['FreePassesStat'])


    def backwards(self, orm):
        # Deleting model 'FreePassesStat'
        db.delete_table('corporate_memberships_freepassesstat')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 20, 0, 0)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 20, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
            'tags': ('tagging.fields.TagField', [], {}),
            'timezone': ('timezones.fields.TimeZoneField', [], {'default': "'America/Chicago'", 'max_length': '100'}),
        ...
        'events.regconfpricing': {
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 21, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
