...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CorpMembershipAppField.order'
        db.delete_column('corporate_memberships_corpmembershipappfield', 'order')


    def backwards(self, orm):
        
        # Adding field 'CorpMembershipAppField.order'
        db.add_column('corporate_memberships_corpmembershipappfield', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 10, 16, 6, 33, 268199)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 10, 16, 6, 33, 268084)'}),
