...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CorporateMembershipType.number_passes'
        db.add_column('corporate_memberships_corporatemembershiptype', 'number_passes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CorporateMembershipType.number_passes'
        db.delete_column('corporate_memberships_corporatemembershiptype', 'number_passes')
