...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'IndivMembershipRenewEntry'
        db.create_table('corporate_memberships_indivmembershiprenewentry', (
            ...
            ('membership', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['memberships.MembershipDefault'])),
            ('status_detail', self.gf('django.db.models.fields.CharField')(default='pending', max_length=50)),
        ))
        db.send_create_signal('corporate_memberships', ['IndivMembershipRenewEntry'])


    def backwards(self, orm):
        
        # Deleting model 'IndivMembershipRenewEntry'
        db.delete_table('corporate_memberships_indivmembershiprenewentry')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 7, 10, 11, 59, 900523)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 7, 10, 11, 59, 900402)'}),
