...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for field in orm.CorpMembershipAppField.objects.all():
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 10, 15, 59, 45, 655411)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 10, 15, 59, 45, 655292)'}),
