...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CorpMembershipApp.include_tax'
        db.add_column('corporate_memberships_corpmembershipapp', 'include_tax',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CorpMembershipApp.tax_rate'
        db.add_column('corporate_memberships_corpmembershipapp', 'tax_rate',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CorpMembershipApp.include_tax'
        db.delete_column('corporate_memberships_corpmembershipapp', 'include_tax')

        # Deleting field 'CorpMembershipApp.tax_rate'
        db.delete_column('corporate_memberships_corpmembershipapp', 'tax_rate')
    ...
    models = {
        ...
        'events.event': {
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 16, 0, 0)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
            'tags': ('tagging.fields.TagField', [], {}),
            'timezone': ('timezones.fields.TimeZoneField', [], {'default': "'America/Chicago'", 'max_length': '100'}),
        ...
        'events.recurringevent': {
            ...
            'starts_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 16, 0, 0)'})
        },
