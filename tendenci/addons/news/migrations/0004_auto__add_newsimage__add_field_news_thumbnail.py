...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'News.thumbnail'
        db.add_column('news_news', 'thumbnail', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['news.NewsImage'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'News.thumbnail'
        db.delete_column('news_news', 'thumbnail_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 22, 12, 56, 6, 378298)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 22, 12, 56, 6, 378192)'}),
        ...
        'news.news': {
            ...
            'thumbnail': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['news.NewsImage']", 'null': 'True', 'blank': 'True'}),
