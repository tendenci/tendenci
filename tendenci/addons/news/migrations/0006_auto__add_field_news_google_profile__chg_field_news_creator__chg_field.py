...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.google_profile'
        db.add_column('news_news', 'google_profile',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


        # Changing field 'News.creator'
        db.alter_column('news_news', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'News.entity'
        db.alter_column('news_news', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['entities.Entity'], null=True))

        # Changing field 'News.owner'
        db.alter_column('news_news', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'News.group'
        db.alter_column('news_news', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_groups.Group'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'News.google_profile'
        db.delete_column('news_news', 'google_profile')


        # Changing field 'News.creator'
        db.alter_column('news_news', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'News.entity'
        db.alter_column('news_news', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['entities.Entity']))

        # Changing field 'News.owner'
        db.alter_column('news_news', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'News.group'
        db.alter_column('news_news', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_groups.Group'], null=True))
    ...
    models = {
        ...
        'news.news': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'news_news_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'news_news_entity'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['entities.Entity']", 'blank': 'True', 'null': 'True'}),
            'fax': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'news_news_owner'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'thumbnail': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['news.NewsImage']", 'null': 'True'}),
        ...
        'news.newsimage': {
            'Meta': {'object_name': 'NewsImage', '_ormbases': ['files.File']},
