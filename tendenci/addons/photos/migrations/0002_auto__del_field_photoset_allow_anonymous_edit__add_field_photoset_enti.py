...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PhotoSet.allow_anonymous_edit'
        db.delete_column('photos_photoset', 'allow_anonymous_edit')

        # Adding field 'PhotoSet.entity'
        db.add_column('photos_photoset', 'entity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='photos_photoset_entity', null=True, blank=True, to=orm['entities.Entity']), keep_default=False)
        ...
        # Deleting field 'Image.allow_anonymous_edit'
        db.delete_column('photos_image', 'allow_anonymous_edit')

        # Adding field 'Image.entity'
        db.add_column('photos_image', 'entity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='photos_image_entity', null=True, blank=True, to=orm['entities.Entity']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'PhotoSet.allow_anonymous_edit'
        db.add_column('photos_photoset', 'allow_anonymous_edit', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'PhotoSet.entity'
        db.delete_column('photos_photoset', 'entity_id')

        # Changing field 'PhotoSet.owner'
        db.alter_column('photos_photoset', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'PhotoSet.creator'
        db.alter_column('photos_photoset', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Adding field 'Image.allow_anonymous_edit'
        db.add_column('photos_image', 'allow_anonymous_edit', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Image.entity'
        db.delete_column('photos_image', 'entity_id')

        # Changing field 'Image.creator'
        db.alter_column('photos_image', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Image.owner'
        db.alter_column('photos_image', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 16, 1, 14, 567230)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 16, 1, 14, 567134)'}),
