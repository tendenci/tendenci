...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.effect'
        db.alter_column('photos_image', 'effect_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['photos.PhotoEffect']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Image.effect'
        db.alter_column('photos_image', 'effect_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['photologue.PhotoEffect']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 30, 9, 35, 0, 685066)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 30, 9, 35, 0, 684728)'}),
