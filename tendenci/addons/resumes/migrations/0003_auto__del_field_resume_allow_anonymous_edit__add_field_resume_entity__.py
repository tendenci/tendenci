...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Resume.allow_anonymous_edit'
        db.delete_column('resumes_resume', 'allow_anonymous_edit')

        # Adding field 'Resume.entity'
        db.add_column('resumes_resume', 'entity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='resumes_resume_entity', null=True, blank=True, to=orm['entities.Entity']), keep_default=False)

        # Changing field 'Resume.owner_username'
        db.alter_column('resumes_resume', 'owner_username', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Resume.creator_username'
        db.alter_column('resumes_resume', 'creator_username', self.gf('django.db.models.fields.CharField')(default='', max_length=50))


    def backwards(self, orm):
        
        # Adding field 'Resume.allow_anonymous_edit'
        db.add_column('resumes_resume', 'allow_anonymous_edit', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Resume.entity'
        db.delete_column('resumes_resume', 'entity_id')

        # Changing field 'Resume.owner_username'
        db.alter_column('resumes_resume', 'owner_username', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Resume.creator_username'
        db.alter_column('resumes_resume', 'creator_username', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 29, 9, 24, 16, 937803)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 29, 9, 24, 16, 937681)'}),
        ...
        'resumes.resume': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'resumes_resume_creator'", 'null': 'True', 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'description': ('tinymce.models.HTMLField', [], {}),
            'education': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'resumes_resume_entity'", 'null': 'True', 'blank': 'True', 'to': "orm['entities.Entity']"}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'resumes_resume_owner'", 'null': 'True', 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
