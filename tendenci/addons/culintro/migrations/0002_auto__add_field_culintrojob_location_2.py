...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CulintroJob.location_2'
        db.add_column('culintro_culintrojob', 'location_2', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['locations.Location'], blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CulintroJob.location_2'
        db.delete_column('culintro_culintrojob', 'location_2_id')
    ...
    models = {
        ...
        'culintro.culintrojob': {
            ...
            'location_2': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['locations.Location']", 'blank': 'True'}),
