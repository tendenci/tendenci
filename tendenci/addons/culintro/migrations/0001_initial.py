...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('culintro_culintrojob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jobs.Job'], unique=True, primary_key=True)),
        ...
        # Adding M2M table for field location_2 on 'CulintroJob'
        db.create_table('culintro_culintrojob_location_2', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('culintrojob', models.ForeignKey(orm['culintro.culintrojob'], null=False)),
            ('location', models.ForeignKey(orm['locations.location'], null=False))
        ))
        db.create_unique('culintro_culintrojob_location_2', ['culintrojob_id', 'location_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field location_2 on 'CulintroJob'
        db.delete_table('culintro_culintrojob_location_2')
    ...
    models = {
        ...
        'culintro.culintrojob': {
            'Meta': {'object_name': 'CulintroJob', '_ormbases': ['jobs.Job']},
            'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jobs.Job']", 'unique': 'True', 'primary_key': 'True'}),
            'location_2': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['locations.Location']", 'symmetrical': 'False', 'blank': 'True'}),
