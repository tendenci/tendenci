...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CulintroJob'
        db.create_table('culintro_culintrojob', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='culintrojob_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='culintrojob_owner', to=orm['auth.User'])),
            ...
            ('list_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ...
            ('level', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('period', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('is_agency', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('percent_travel', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('contact_method', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('position_reports_to', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('salary_from', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('salary_to', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('computer_skills', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('requested_duration', self.gf('django.db.models.fields.IntegerField')()),
            ('pricing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobs.JobPricing'], null=True)),
            ('activation_dt', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('post_dt', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ...
            ('job_url', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ...
            ('contact_company', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('contact_name', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('contact_address', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('contact_address2', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('contact_city', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('contact_state', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('contact_zip_code', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('contact_country', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('contact_phone', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('contact_fax', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('contact_email', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('contact_website', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ...
            ('payment_method', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True)),
            ('member_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2, blank=True)),
            ('member_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('non_member_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2, blank=True)),
            ('non_member_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('location_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True, blank=True)),
            ('location_other', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('open_call', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('promote_posting', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('culintro', ['CulintroJob'])


    def backwards(self, orm):
        
        # Deleting model 'CulintroJob'
        db.delete_table('culintro_culintrojob')
    ...
    models = {
        ...
        'culintro.culintrojob': {
            'Meta': {'object_name': 'CulintroJob'},
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'culintrojob_creator'", 'to': "orm['auth.User']"}),
            ...
            'location_2': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['locations.Location']", 'null': 'True', 'blank': 'True'}),
            'location_other': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'open_call': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'culintrojob_owner'", 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'payment_method': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
            'percent_travel': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'promote_posting': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
