...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('culintro_location', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('culintro', ['Location'])

        # Changing field 'CulintroJob.location_2'
        db.alter_column('culintro_culintrojob', 'location_2_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['culintro.Location'], null=True))


    def backwards(self, orm):
        
        # Deleting model 'Location'
        db.delete_table('culintro_location')

        # Changing field 'CulintroJob.location_2'
        db.alter_column('culintro_culintrojob', 'location_2_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True))
    ...
    models = {
        ...
        'culintro.culintrojob': {
            ...
            'location_2': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['culintro.Location']", 'null': 'True', 'blank': 'True'}),
