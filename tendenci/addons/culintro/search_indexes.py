...
class CulintroJobIndex(TendenciBaseSearchIndex):
    ...
    location_2 = indexes.CharField(model_attr='location_2', null=True)
    
    # categories
    categories = indexes.CharField()
    sub_categories = indexes.CharField()
    ...
    def prepare_sub_categories(self, obj):
