...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmergencyAnnouncement'
        db.create_table('announcements_emergencyannouncement', (
            ...
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='announcements_emergencyannouncement_entity', on_delete=models.SET_NULL, default=None, to=orm['entities.Entity'], blank=True, null=True)),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='announcements_emergencyannouncement_creator', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='announcements_emergencyannouncement_owner', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
        ...
        db.send_create_signal('announcements', ['EmergencyAnnouncement'])


    def backwards(self, orm):
        # Deleting model 'EmergencyAnnouncement'
        db.delete_table('announcements_emergencyannouncement')
    ...
    models = {
        'announcements.emergencyannouncement': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'announcements_emergencyannouncement_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'announcements_emergencyannouncement_entity'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['entities.Entity']", 'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'announcements_emergencyannouncement_owner'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"}),
