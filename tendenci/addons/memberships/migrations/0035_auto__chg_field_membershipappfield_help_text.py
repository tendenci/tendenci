...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MembershipAppField.help_text'
        db.alter_column('memberships_membershipappfield', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'MembershipAppField.help_text'
        db.alter_column('memberships_membershipappfield', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=200))
