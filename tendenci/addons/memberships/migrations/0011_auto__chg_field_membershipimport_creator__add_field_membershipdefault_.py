...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MembershipDefault.corp_profile_id'
        db.add_column('memberships_membershipdefault', 'corp_profile_id', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'MembershipImport.creator'
        raise RuntimeError("Cannot reverse this migration. 'MembershipImport.creator' and its values cannot be restored.")

        # Deleting field 'MembershipDefault.corp_profile_id'
        db.delete_column('memberships_membershipdefault', 'corp_profile_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 6, 21, 15, 41, 553293)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 6, 21, 15, 41, 553186)'}),
