...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for field in orm.MembershipAppField.objects.all():
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 14, 58, 45, 976859)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 14, 58, 45, 976742)'}),
