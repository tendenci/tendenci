...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MembershipAppField'
        db.create_table('memberships_membershipappfield', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('membership_app', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fields', to=orm['memberships.MembershipApp'])),
            ...
            ('help_text', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('choices', self.gf('django.db.models.fields.CharField')(max_length=1000, blank=True)),
            ('default_value', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('css_class', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('memberships', ['MembershipAppField'])

        # Adding model 'MembershipApp'
        db.create_table('memberships_membershipapp', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='memberships_membershipapp_entity', null=True, blank=True, to=orm['entities.Entity'])),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='memberships_membershipapp_creator', null=True, to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='memberships_membershipapp_owner', null=True, to=orm['auth.User'])),
            ...
            ('use_for_corp', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('memberships', ['MembershipApp'])

        # Adding M2M table for field membership_types on 'MembershipApp'
        db.create_table('memberships_membershipapp_membership_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('membershipapp', models.ForeignKey(orm['memberships.membershipapp'], null=False)),
            ('membershiptype', models.ForeignKey(orm['memberships.membershiptype'], null=False))
        ))
        db.create_unique('memberships_membershipapp_membership_types', ['membershipapp_id', 'membershiptype_id'])

        # Adding M2M table for field payment_methods on 'MembershipApp'
        db.create_table('memberships_membershipapp_payment_methods', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('membershipapp', models.ForeignKey(orm['memberships.membershipapp'], null=False)),
            ('paymentmethod', models.ForeignKey(orm['payments.paymentmethod'], null=False))
        ))
        db.create_unique('memberships_membershipapp_payment_methods', ['membershipapp_id', 'paymentmethod_id'])


    def backwards(self, orm):
        
        # Deleting model 'MembershipAppField'
        db.delete_table('memberships_membershipappfield')

        # Deleting model 'MembershipApp'
        db.delete_table('memberships_membershipapp')

        # Removing M2M table for field membership_types on 'MembershipApp'
        db.delete_table('memberships_membershipapp_membership_types')

        # Removing M2M table for field payment_methods on 'MembershipApp'
        db.delete_table('memberships_membershipapp_payment_methods')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 9, 17, 1, 17, 803159)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 9, 17, 1, 17, 803038)'}),
