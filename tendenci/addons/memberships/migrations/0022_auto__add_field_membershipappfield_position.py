...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MembershipAppField.position'
        db.add_column('memberships_membershipappfield', 'position', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MembershipAppField.position'
        db.delete_column('memberships_membershipappfield', 'position')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 14, 55, 26, 23051)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 14, 55, 26, 22933)'}),
