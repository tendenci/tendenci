...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        """
        from tendenci.addons.memberships.models import MembershipAppField
        MembershipAppField.objects.filter(field_name='corporate_entity'
                                          ).delete()
        MembershipAppField.objects.filter(field_name='organization_entity'
                                          ).delete()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 26, 11, 10, 51, 367814)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 26, 11, 10, 51, 367687)'}),
