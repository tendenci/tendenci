...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MembershipImport.recap_file'
        db.add_column('memberships_membershipimport', 'recap_file', self.gf('django.db.models.fields.files.FileField')(max_length=260, null=True), keep_default=False)

        # Adding field 'MembershipImport.header_line'
        db.add_column('memberships_membershipimport', 'header_line', self.gf('django.db.models.fields.CharField')(default='', max_length=3000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MembershipImport.recap_file'
        db.delete_column('memberships_membershipimport', 'recap_file')

        # Deleting field 'MembershipImport.header_line'
        db.delete_column('memberships_membershipimport', 'header_line')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 11, 16, 10, 52, 648380)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 11, 16, 10, 52, 648227)'}),
