...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NoticeEmail.guid'
        db.add_column('notifications_noticeemail', 'guid', self.gf('django.db.models.fields.CharField')(default='1111', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NoticeEmail.guid'
        db.delete_column('notifications_noticeemail', 'guid')
