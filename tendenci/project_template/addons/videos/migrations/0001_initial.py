...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('videos_video', (
            ...
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='videos_video_entity', null=True, blank=True, to=orm['entities.Entity'])),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='videos_video_creator', null=True, to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='videos_video_owner', null=True, to=orm['auth.User'])),
        ...
        # Adding model 'OembedlyCache'
        db.create_table('videos_oembedlycache', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=800)),
            ('width', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('height', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('code', self.gf('django.db.models.fields.TextField')()),
            ('thumbnail', self.gf('django.db.models.fields.CharField')(max_length=800)),
        ))
        db.send_create_signal('videos', ['OembedlyCache'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'OembedlyCache'
        db.delete_table('videos_oembedlycache')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 17, 2, 44, 694010)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 17, 2, 44, 693921)'}),
        ...
        'videos.oembedlycache': {
            'Meta': {'object_name': 'OembedlyCache'},
            'code': ('django.db.models.fields.TextField', [], {}),
            'height': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'thumbnail': ('django.db.models.fields.CharField', [], {'max_length': '800'}),
            'url': ('django.db.models.fields.CharField', [], {'max_length': '800'}),
        ...
        'videos.video': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'videos_video_owner'", 'null': 'True', 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
