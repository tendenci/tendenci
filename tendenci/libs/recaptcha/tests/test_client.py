...
class TestClient(TestCase):
    @patch("tendenci.libs.recaptcha.client.recaptcha_request")
    ...
    @patch("tendenci.libs.recaptcha.client.Request")
    @patch("tendenci.libs.recaptcha.client.build_opener")
    def test_client_request(self, mocked_builder, mocked_request):
        ...
        self.assertIn(f"secret={ settings.RECAPTCHA_PRIVATE_KEY }", mocked_request.call_args.__str__())
    ...
    @patch("tendenci.libs.recaptcha.client.ProxyHandler")
    @patch("tendenci.libs.recaptcha.client.Request")
    @patch("tendenci.libs.recaptcha.client.build_opener")
