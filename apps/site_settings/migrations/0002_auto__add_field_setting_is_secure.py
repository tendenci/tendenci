...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Setting.is_secure'
        db.add_column('site_settings_setting', 'is_secure', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Setting.is_secure'
        db.delete_column('site_settings_setting', 'is_secure')
