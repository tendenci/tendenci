...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.license'
        db.alter_column('photos_image', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['photos.License']))


    def backwards(self, orm):
        
        # Changing field 'Image.license'
        db.alter_column('photos_image', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['photos.License']))
    ...
    models = {
        ...
        'photos.image': {
            ...
            'license': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'license'", 'null': 'True', 'to': "orm['photos.License']"}),
