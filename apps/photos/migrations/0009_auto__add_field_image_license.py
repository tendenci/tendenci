...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('photos_image', 'license', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='license', null=True, to=orm['photos.License']), keep_default=False)
    ...
    models = {
        ...
        'photos.image': {
            ...
            'license': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'license'", 'null': 'True', 'to': "orm['photos.License']"}),
