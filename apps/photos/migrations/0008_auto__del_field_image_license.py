...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('photos_image', 'license', self.gf('django.db.models.fields.related.ForeignKey')(related_name='license', null=True, to=orm['photos.License']), keep_default=False)
