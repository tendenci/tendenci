...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('photos_image', 'meta', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['meta.Meta'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.meta'
        db.delete_column('photos_image', 'meta_id')
