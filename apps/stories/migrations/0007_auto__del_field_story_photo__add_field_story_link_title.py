...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Story.link_title'
        db.add_column('stories_story', 'link_title', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Story.link_title'
        db.delete_column('stories_story', 'link_title')
