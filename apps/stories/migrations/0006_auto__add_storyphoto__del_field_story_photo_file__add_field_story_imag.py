...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('stories_story', 'image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stories.StoryPhoto'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('stories_story', 'image_id')
