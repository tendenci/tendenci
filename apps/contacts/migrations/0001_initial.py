...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contacts_contact', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_owner', to=orm['auth.User'])),
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contact_owner'", 'to': "orm['auth.User']"}),
