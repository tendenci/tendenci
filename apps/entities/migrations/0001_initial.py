...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('entities_entity', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_owner', to=orm['auth.User'])),
            ...
            ('entity_name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('entity_type', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('entity_parent_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
