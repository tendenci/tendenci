...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MembershipImport.interactive'
        db.add_column('memberships_membershipimport', 'interactive', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'MembershipImport.override'
        db.add_column('memberships_membershipimport', 'override', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'MembershipImport.key'
        db.add_column('memberships_membershipimport', 'key', self.gf('django.db.models.fields.CharField')(default='email', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MembershipImport.interactive'
        db.delete_column('memberships_membershipimport', 'interactive')

        # Deleting field 'MembershipImport.override'
        db.delete_column('memberships_membershipimport', 'override')

        # Deleting field 'MembershipImport.key'
        db.delete_column('memberships_membershipimport', 'key')
