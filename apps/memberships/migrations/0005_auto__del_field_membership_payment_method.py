...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('memberships_membership', 'payment_method')


    def backwards(self, orm):
        
        # Adding field 'Membership.payment_method'
        db.add_column('memberships_membership', 'payment_method', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)
