...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membership.send_notice'
        db.add_column('memberships_membership', 'send_notice', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Membership.send_notice'
        db.delete_column('memberships_membership', 'send_notice')
