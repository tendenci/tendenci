...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AppField.exportable'
        db.add_column('memberships_appfield', 'exportable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AppField.exportable'
        db.delete_column('memberships_appfield', 'exportable')
