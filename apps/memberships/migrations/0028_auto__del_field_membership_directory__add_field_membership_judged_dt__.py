...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Membership.directory'
        db.delete_column('memberships_membership', 'directory_id')

        # Adding field 'Membership.judged_dt'
        db.add_column('memberships_membership', 'judged_dt', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Membership.judge'
        db.add_column('memberships_membership', 'judge', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='memberships_judged', null=True, to=orm['auth.User']), keep_default=False)

        # Changing field 'Membership.invoice'
        db.alter_column('memberships_membership', 'invoice_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['invoices.Invoice'], unique=True, null=True))

        # Adding unique constraint on 'Membership', fields ['invoice']
        db.create_unique('memberships_membership', ['invoice_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Membership', fields ['invoice']
        db.delete_unique('memberships_membership', ['invoice_id'])

        # Adding field 'Membership.directory'
        db.add_column('memberships_membership', 'directory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directories.Directory'], null=True, blank=True), keep_default=False)

        # Deleting field 'Membership.judged_dt'
        db.delete_column('memberships_membership', 'judged_dt')

        # Deleting field 'Membership.judge'
        db.delete_column('memberships_membership', 'judge_id')

        # Changing field 'Membership.invoice'
        db.alter_column('memberships_membership', 'invoice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoices.Invoice'], null=True))
    ...
    models = {
        ...
        'memberships.membership': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['invoices.Invoice']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'judge': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'memberships_judged'", 'null': 'True', 'to': "orm['auth.User']"}),
            'judged_dt': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'ma': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['memberships.App']", 'null': 'True', 'blank': 'True'}),
