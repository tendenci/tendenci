...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membership.payment_method_temp'
        db.add_column('memberships_membership', 'payment_method_temp', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Membership.payment_method_temp'
        db.delete_column('memberships_membership', 'payment_method_temp')
    ...
    models = {
        ...
        'memberships.membership': {
            ...
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'payment_method': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'payment_method_temp': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
