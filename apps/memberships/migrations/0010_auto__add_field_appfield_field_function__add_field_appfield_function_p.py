...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AppField.field_function'
        db.add_column('memberships_appfield', 'field_function', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'AppField.function_params'
        db.add_column('memberships_appfield', 'function_params', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AppField.field_function'
        db.delete_column('memberships_appfield', 'field_function')

        # Deleting field 'AppField.function_params'
        db.delete_column('memberships_appfield', 'function_params')
