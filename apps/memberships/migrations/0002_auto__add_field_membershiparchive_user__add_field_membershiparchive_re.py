...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MembershipArchive.user'
        db.add_column('memberships_membershiparchive', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1L, to=orm['auth.User']), keep_default=False)

        # Adding field 'MembershipArchive.renewal'
        db.add_column('memberships_membershiparchive', 'renewal', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'MembershipArchive.subscribe_dt'
        db.add_column('memberships_membershiparchive', 'subscribe_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 5, 6)), keep_default=False)

        # Adding field 'Membership.subscribe_dt'
        db.add_column('memberships_membership', 'subscribe_dt', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MembershipArchive.user'
        db.delete_column('memberships_membershiparchive', 'user_id')

        # Deleting field 'MembershipArchive.renewal'
        db.delete_column('memberships_membershiparchive', 'renewal')

        # Deleting field 'MembershipArchive.subscribe_dt'
        db.delete_column('memberships_membershiparchive', 'subscribe_dt')

        # Deleting field 'Membership.subscribe_dt'
        db.delete_column('memberships_membership', 'subscribe_dt')
    ...
    models = {
        ...
        'memberships.membership': {
            ...
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
            'subscribe_dt': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'update_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
