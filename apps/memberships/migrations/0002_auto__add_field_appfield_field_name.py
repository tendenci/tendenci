...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AppField.field_name'
        db.add_column('memberships_appfield', 'field_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AppField.field_name'
        db.delete_column('memberships_appfield', 'field_name')
