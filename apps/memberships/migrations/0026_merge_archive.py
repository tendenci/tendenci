...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        - Set status_detail="expired" for all membership log_records
            in membership archive table.
        - Copy over all membership archive records to membership table.
        - Delete membership archive table.
        - Delete content type record
        """
        Membership = orm['memberships.Membership']
        MembershipArchive = orm['memberships.MembershipArchive']

        MembershipArchive.objects.update(status_detail='expired')
        ...
        for membership_archive in membership_archives:
            ...
            for field in Membership._meta.fields:
                ...
                if hasattr(membership_archive, field.name):
                    setattr(membership, field.name, getattr(membership_archive, field.name))
