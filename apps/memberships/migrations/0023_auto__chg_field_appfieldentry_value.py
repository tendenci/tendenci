...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AppFieldEntry.value'
        db.alter_column('memberships_appfieldentry', 'value', self.gf('django.db.models.fields.CharField')(max_length=2000))


    def backwards(self, orm):
        
        # Changing field 'AppFieldEntry.value'
        db.alter_column('memberships_appfieldentry', 'value', self.gf('django.db.models.fields.CharField')(max_length=200))
