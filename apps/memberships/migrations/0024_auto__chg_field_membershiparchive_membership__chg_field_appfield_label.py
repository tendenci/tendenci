...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MembershipArchive.membership'
        db.alter_column('memberships_membershiparchive', 'membership_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['memberships.Membership'], null=True))

        # Changing field 'AppField.label'
        db.alter_column('memberships_appfield', 'label', self.gf('django.db.models.fields.CharField')(max_length=2000))


    def backwards(self, orm):
        
        # Changing field 'MembershipArchive.membership'
        db.alter_column('memberships_membershiparchive', 'membership_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['memberships.Membership']))

        # Changing field 'AppField.label'
        db.alter_column('memberships_appfield', 'label', self.gf('django.db.models.fields.CharField')(max_length=1000))
    ...
    models = {
        ...
        'memberships.membershiparchive': {
            ...
            'member_number': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'membership': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['memberships.Membership']", 'null': 'True'}),
