...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pages_page', 'header_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pages.HeaderImage'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('pages_page', 'header_image_id')
