...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('files_file', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='file_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='file_owner', to=orm['auth.User'])),
