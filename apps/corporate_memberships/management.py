...
# corp_memb_renewed - send email notification to dues reps
# corp_memb_renewal_approved - send email notification to dues reps that the renewal has been approved
if "notification" in settings.INSTALLED_APPS:
    ...
    def create_notice_types(app, created_models, verbosity, **kwargs):
        ...
        notification.create_notice_type("corp_memb_renewal_approved", _("Corporate Membership Renewal Approved"), 
                                        _("The corporate membership renewal has been renewed."))
