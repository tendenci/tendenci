...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Invoice.receip'
        db.delete_column('invoices_invoice', 'receip')

        # Adding field 'Invoice.receipt'
        db.add_column('invoices_invoice', 'receipt', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Invoice.receip'
        db.add_column('invoices_invoice', 'receip', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'Invoice.receipt'
        db.delete_column('invoices_invoice', 'receipt')
