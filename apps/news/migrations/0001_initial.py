...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('news_news', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='news_owner', to=orm['auth.User'])),
    ...
    models = {
        ...
        'news.news': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'news_owner'", 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
