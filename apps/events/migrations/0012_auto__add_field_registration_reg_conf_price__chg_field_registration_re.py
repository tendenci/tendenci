...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Registration.reg_conf_price'
        db.add_column('events_registration', 'reg_conf_price', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.RegConfPricing'], null=True), keep_default=False)
        ...
        # Adding field 'RegConfPricing.allow_anonymous'
        db.add_column('events_regconfpricing', 'allow_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'RegConfPricing.allow_user'
        db.add_column('events_regconfpricing', 'allow_user', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'RegConfPricing.allow_member'
        db.add_column('events_regconfpricing', 'allow_member', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
        ...
        db.alter_column('events_registrationconfiguration', 'is_guest_price', self.gf('django.db.models.fields.BooleanField')(blank=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Registration.reg_conf_price'
        db.delete_column('events_registration', 'reg_conf_price_id')

        # Changing field 'Registration.reminder'
        db.alter_column('events_registration', 'reminder', self.gf('django.db.models.fields.BooleanField')())

        # Deleting field 'RegConfPricing.allow_anonymous'
        db.delete_column('events_regconfpricing', 'allow_anonymous')

        # Deleting field 'RegConfPricing.allow_user'
        db.delete_column('events_regconfpricing', 'allow_user')

        # Deleting field 'RegConfPricing.allow_member'
        db.delete_column('events_regconfpricing', 'allow_member')
        ...
        # Changing field 'RegistrationConfiguration.is_guest_price'
        db.alter_column('events_registrationconfiguration', 'is_guest_price', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 29, 14, 49, 34, 154074)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 29, 14, 49, 34, 154039)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'allow_anonymous': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'allow_member': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'allow_user': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
