...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RegistrationConfiguration.late_price'
        db.delete_column('events_registrationconfiguration', 'late_price')

        # Deleting field 'RegistrationConfiguration.early_price'
        db.delete_column('events_registrationconfiguration', 'early_price')

        # Deleting field 'RegistrationConfiguration.regular_price'
        db.delete_column('events_registrationconfiguration', 'regular_price')

        # Deleting field 'RegistrationConfiguration.early_dt'
        db.delete_column('events_registrationconfiguration', 'early_dt')

        # Deleting field 'RegistrationConfiguration.late_dt'
        db.delete_column('events_registrationconfiguration', 'late_dt')

        # Deleting field 'RegistrationConfiguration.regular_dt'
        db.delete_column('events_registrationconfiguration', 'regular_dt')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'RegistrationConfiguration.late_price'
        db.add_column('events_registrationconfiguration', 'late_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2), keep_default=False)

        # Adding field 'RegistrationConfiguration.early_price'
        db.add_column('events_registrationconfiguration', 'early_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2), keep_default=False)

        # Adding field 'RegistrationConfiguration.regular_price'
        db.add_column('events_registrationconfiguration', 'regular_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2), keep_default=False)

        # We cannot add back in field 'RegistrationConfiguration.early_dt'
        raise RuntimeError(
            "Cannot reverse this migration. 'RegistrationConfiguration.early_dt' and its values cannot be restored.")

        # We cannot add back in field 'RegistrationConfiguration.late_dt'
        raise RuntimeError(
            "Cannot reverse this migration. 'RegistrationConfiguration.late_dt' and its values cannot be restored.")

        # We cannot add back in field 'RegistrationConfiguration.regular_dt'
        raise RuntimeError(
            "Cannot reverse this migration. 'RegistrationConfiguration.regular_dt' and its values cannot be restored.")
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 12, 15, 2, 38, 331253)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 12, 15, 2, 38, 331175)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
