...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'GroupRegistrationConfiguration'
        db.delete_table('events_groupregistrationconfiguration')

        # Deleting model 'SpecialPricing'
        db.delete_table('events_specialpricing')
    ...
    def backwards(self, orm):
        ...
        # Adding model 'GroupRegistrationConfiguration'
        db.create_table('events_groupregistrationconfiguration', (
            ('regular_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2)),
            ...
            ('config', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.RegistrationConfiguration'], null=True)),
            ('early_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('late_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_dt', self.gf('django.db.models.fields.DateTimeField')(default=0)),
        ))
        db.send_create_signal('events', ['GroupRegistrationConfiguration'])

        # Adding model 'SpecialPricing'
        db.create_table('events_specialpricing', (
            ('regular_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2)),
            ('regular_dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_groups.Group'], null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('events', ['SpecialPricing'])
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 12, 15, 1, 22, 448651)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 12, 15, 1, 22, 448585)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
