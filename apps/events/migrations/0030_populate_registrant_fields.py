...
def get_value_of_mapped_field(entry, map_to_field, orm):
    mapped_field = orm.CustomRegField.objects.filter(form=entry.form, map_to_field=map_to_field)
    if mapped_field:
        field_entries = mapped_field[0].entries.filter(entry=entry)
        if field_entries:
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        registrants = orm.Registrant.objects.all()
        for registrant in registrants:
            if registrant.custom_reg_form_entry:
                # registrant.initialize_fields() # can't call because south has own versions of each model
                if registrant.custom_reg_form_entry:
                    registrant.first_name = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'first_name', orm)
                    registrant.last_name = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'last_name', orm)
                    registrant.mail_name = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'mail_name', orm)
                    registrant.address = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'address', orm)
                    registrant.city = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'city', orm)
                    registrant.state = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'state', orm)
                    registrant.zip = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'zip', orm)
                    registrant.country = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'country', orm)
                    registrant.phone = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'phone', orm)
                    registrant.email = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'email', orm)
                    registrant.groups = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'groups', orm)
                    registrant.position_title = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'position_title', orm)
                    registrant.company_name = get_value_of_mapped_field(registrant.custom_reg_form_entry, 'company_name', orm)
                if registrant.first_name or registrant.last_name:
                    registrant.name = ('%s %s' % (registrant.first_name, registrant.last_name)).strip()
                registrant.save()

    def backwards(self, orm):
        """Can't be reversed, pass instead"""
        pass
    ...
    models = {
        ...
        'events.customregform': {
            ...
            'update_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'validate_guest': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 21, 19, 40, 14, 190150)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 21, 17, 40, 14, 190125)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'allow_member': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_user': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 21, 23, 40, 14, 183214)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 21, 17, 40, 14, 183185)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
