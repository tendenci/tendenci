...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RegistrationDate'
        db.create_table('events_registrationdate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reg_conf_price', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dates', to=orm['events.RegConfPricing'])),
            ...
            ('start_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 22, 1, 28, 49, 648147))),
        ))
        db.send_create_signal('events', ['RegistrationDate'])


    def backwards(self, orm):
        
        # Deleting model 'RegistrationDate'
        db.delete_table('events_registrationdate')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 3, 28, 49, 660708)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 1, 28, 49, 660648)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'early_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 1, 28, 49, 646665)'}),
            'early_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 7, 28, 49, 646863)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'late_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 5, 28, 49, 646795)'}),
            ...
            'regular_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 3, 28, 49, 646721)'}),
        ...
        'events.registrationdate': {
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 1, 28, 49, 648147)'})
        },
        'events.speaker': {
