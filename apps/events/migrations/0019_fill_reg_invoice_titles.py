...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        regs = orm.Registration.objects.all()
        for reg in regs:
            if reg.invoice:
                reg.invoice.title = "Registration %s for Event: %s" % (reg.pk, reg.event.title)
                reg.invoice.save()
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 9, 5, 55, 57, 169178)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 9, 3, 55, 57, 169069)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 9, 9, 55, 57, 152374)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 9, 3, 55, 57, 152305)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
