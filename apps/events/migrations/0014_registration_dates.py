...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for pricing in orm.RegConfPricing.objects.all():
            #create the early date
            orm.RegistrationDate.objects.create(
                    reg_conf_price = pricing,
                    label = "Early",
                    price = pricing.early_price,
                    start_dt = pricing.early_dt,
                )
            orm.RegistrationDate.objects.create(
                    reg_conf_price = pricing,
                    label = "Regular",
            ...
            orm.RegistrationDate.objects.create(
                    reg_conf_price = pricing,
                    label = "Late",
                    price = pricing.late_price,
                    start_dt = pricing.late_dt,
                )
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 3, 31, 49, 686271)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 1, 31, 49, 686219)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'early_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 1, 31, 49, 671197)'}),
            'early_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 7, 31, 49, 671389)'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'late_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 5, 31, 49, 671322)'}),
            ...
            'regular_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 3, 31, 49, 671249)'}),
        ...
        'events.registrationdate': {
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 1, 31, 49, 673160)'})
        },
        'events.speaker': {
