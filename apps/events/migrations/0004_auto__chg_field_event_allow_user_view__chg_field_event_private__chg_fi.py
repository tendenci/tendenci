...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Registrant.amount'
        db.add_column('events_registrant', 'amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Registrant.amount'
        db.delete_column('events_registrant', 'amount')
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 25, 18, 24, 6, 739000)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 25, 18, 24, 6, 739000)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
