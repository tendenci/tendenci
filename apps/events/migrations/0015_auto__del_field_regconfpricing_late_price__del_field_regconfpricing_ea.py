...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RegConfPricing.late_price'
        db.delete_column('events_regconfpricing', 'late_price')

        # Deleting field 'RegConfPricing.early_price'
        db.delete_column('events_regconfpricing', 'early_price')

        # Deleting field 'RegConfPricing.regular_price'
        db.delete_column('events_regconfpricing', 'regular_price')

        # Deleting field 'RegConfPricing.early_dt'
        db.delete_column('events_regconfpricing', 'early_dt')

        # Deleting field 'RegConfPricing.late_dt'
        db.delete_column('events_regconfpricing', 'late_dt')

        # Deleting field 'RegConfPricing.regular_dt'
        db.delete_column('events_regconfpricing', 'regular_dt')


    def backwards(self, orm):
        
        # Adding field 'RegConfPricing.late_price'
        db.add_column('events_regconfpricing', 'late_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2), keep_default=False)

        # Adding field 'RegConfPricing.early_price'
        db.add_column('events_regconfpricing', 'early_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2), keep_default=False)

        # Adding field 'RegConfPricing.regular_price'
        db.add_column('events_regconfpricing', 'regular_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=21, decimal_places=2), keep_default=False)

        # Adding field 'RegConfPricing.early_dt'
        db.add_column('events_regconfpricing', 'early_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 22, 1, 31, 49, 671197)), keep_default=False)

        # Adding field 'RegConfPricing.late_dt'
        db.add_column('events_regconfpricing', 'late_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 22, 5, 31, 49, 671322)), keep_default=False)

        # Adding field 'RegConfPricing.regular_dt'
        db.add_column('events_regconfpricing', 'regular_dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 22, 3, 31, 49, 671249)), keep_default=False)
    ...
    models = {
        ...
        'events.event': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 3, 51, 53, 963216)'}),
            ...
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 1, 51, 53, 963166)'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
        ...
        'events.regconfpricing': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 7, 51, 53, 950794)'}),
        ...
        'events.registrationdate': {
            'Meta': {'object_name': 'RegistrationDate'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '21', 'decimal_places': '2'}),
            'reg_conf_price': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dates'", 'to': "orm['events.RegConfPricing']"}),
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 22, 1, 51, 53, 951626)'})
        },
        'events.speaker': {
