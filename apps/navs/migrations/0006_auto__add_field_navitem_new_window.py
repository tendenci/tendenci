...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NavItem.new_window'
        db.add_column('navs_navitem', 'new_window', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NavItem.new_window'
        db.delete_column('navs_navitem', 'new_window')
