...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NavItem.url'
        db.add_column('navs_navitem', 'url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Changing field 'NavItem.page'
        db.alter_column('navs_navitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pages.Page'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'NavItem.url'
        db.delete_column('navs_navitem', 'url')

        # Changing field 'NavItem.page'
        db.alter_column('navs_navitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['pages.Page']))
