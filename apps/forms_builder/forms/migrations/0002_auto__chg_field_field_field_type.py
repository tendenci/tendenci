...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('forms_field', 'field_type', self.gf('django.db.models.fields.CharField')(max_length=64))


    def backwards(self, orm):
        
        # Changing field 'Field.field_type'
        db.alter_column('forms_field', 'field_type', self.gf('django.db.models.fields.CharField')(max_length=50))
