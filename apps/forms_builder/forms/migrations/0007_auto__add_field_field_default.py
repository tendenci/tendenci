...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Field.default'
        db.add_column('forms_field', 'default', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Field.default'
        db.delete_column('forms_field', 'default')
