...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Field.label'
        db.alter_column('forms_field', 'label', self.gf('django.db.models.fields.CharField')(max_length=2000))


    def backwards(self, orm):
        
        # Changing field 'Field.label'
        db.alter_column('forms_field', 'label', self.gf('django.db.models.fields.CharField')(max_length=255))
