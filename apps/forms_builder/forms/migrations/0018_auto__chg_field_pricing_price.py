...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pricing.price'
        db.alter_column('forms_pricing', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'Pricing.price'
        db.alter_column('forms_pricing', 'price', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=2))
