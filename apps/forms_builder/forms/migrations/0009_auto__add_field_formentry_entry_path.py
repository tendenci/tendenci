...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormEntry.entry_path'
        db.add_column('forms_formentry', 'entry_path', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FormEntry.entry_path'
        db.delete_column('forms_formentry', 'entry_path')
