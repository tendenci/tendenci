...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Form.email_text'
        db.add_column('forms_form', 'email_text', self.gf('django.db.models.fields.TextField')(default='', max_length=2000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Form.email_text'
        db.delete_column('forms_form', 'email_text')
    ...
    models = {
        ...
        'forms.form': {
            ...
            'email_text': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '2000'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
