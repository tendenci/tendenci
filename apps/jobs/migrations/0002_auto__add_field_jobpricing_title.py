...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JobPricing.title'
        db.add_column('jobs_jobpricing', 'title', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'JobPricing.title'
        db.delete_column('jobs_jobpricing', 'title')
