...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EventLog.uuid'
        db.delete_column('event_logs_eventlog', 'uuid')

        # Deleting field 'EventLog.application'
        db.delete_column('event_logs_eventlog', 'application')

        # Deleting field 'EventLog.action'
        db.delete_column('event_logs_eventlog', 'action')

        # Deleting field 'EventLog.model_name'
        db.delete_column('event_logs_eventlog', 'model_name')
