...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('actions_action', (
            ...
            ('sla', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('task_result', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        ...
        db.create_table('actions_actionrecap', (
            ...
            ('attempted', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('failed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('recap', self.gf('django.db.models.fields.TextField')(null=True)),
            ('create_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
    ...
    models = {
        'actions.action': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'action_creator'", 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'due_dt': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'email': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['emails.Email']", 'null': 'True', 'blank': 'True'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'action_owner'", 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'responses': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'returned': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'starting_point': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
