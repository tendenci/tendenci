...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DirectoryPricing.regular_price_member'
        db.add_column('directories_directorypricing', 'regular_price_member', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'DirectoryPricing.premium_price_member'
        db.add_column('directories_directorypricing', 'premium_price_member', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'DirectoryPricing.show_member_pricing'
        db.add_column('directories_directorypricing', 'show_member_pricing', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DirectoryPricing.regular_price_member'
        db.delete_column('directories_directorypricing', 'regular_price_member')

        # Deleting field 'DirectoryPricing.premium_price_member'
        db.delete_column('directories_directorypricing', 'premium_price_member')

        # Deleting field 'DirectoryPricing.show_member_pricing'
        db.delete_column('directories_directorypricing', 'show_member_pricing')
