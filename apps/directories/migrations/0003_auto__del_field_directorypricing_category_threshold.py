...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DirectoryPricing.category_threshold'
        db.delete_column('directories_directorypricing', 'category_threshold')


    def backwards(self, orm):
        
        # Adding field 'DirectoryPricing.category_threshold'
        db.add_column('directories_directorypricing', 'category_threshold', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)
