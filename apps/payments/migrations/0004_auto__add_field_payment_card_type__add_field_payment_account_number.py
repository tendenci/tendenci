...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Payment.card_type'
        db.add_column('payments_payment', 'card_type', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True), keep_default=False)

        # Adding field 'Payment.account_number'
        db.add_column('payments_payment', 'account_number', self.gf('django.db.models.fields.CharField')(default='', max_length=4, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Payment.card_type'
        db.delete_column('payments_payment', 'card_type')

        # Deleting field 'Payment.account_number'
        db.delete_column('payments_payment', 'account_number')
