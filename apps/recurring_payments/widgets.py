...
from models import BILLING_PERIOD_CHOICES
...
#                      'due_borf': (1, forms.Select()),
#                      'due_sore':(2, forms.Select()),
#                       }
#        self.widgets = ()
#        if self.pos_d:
...
#        
#        # before or after
#        due_borf_widget = self.pos_d['due_borf'][1]
#        due_borf_widget.choices = DUE_BORF_CHOICES
#        rendered_due_borf = self.render_widget(due_borf_widget, 
#                                    name, value, final_attrs, self.pos_d['due_borf'][0], id_)
#        
