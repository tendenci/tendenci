...
class RecurringPayment(models.Model):
            ...
            for cim_payment_profile in cim_payment_profiles:
                ...
                if not payment_profile_exists:
                    ...
                    if cim_payment_profile['payment'].has_key('credit_card') and \
                        ...
                        card_num = cim_payment_profiles['payment']['credit_card']['card_number'][-4:]
    ...
    def create_invoice(self, bill_cycle):
        """
        ...
        self.next_billing_dt = bill_cycle.start
        ...
        rp_invoice = RecurringPaymentInvoice(
                                             ...
                                             invoice=inv,
                                             billing_cycle_start_dt=bill_cycle.start,
                                             billing_cycle_end_dt=bill_cycle.end,
                                             )
        rp_invoice.save()
...
class RecurringPaymentInvoice(models.Model):
    ...
    def make_payment_transaction(self):
        pass
