...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RecurringPayment.tax_exempt'
        db.add_column('recurring_payments_recurringpayment', 'tax_exempt', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RecurringPayment.tax_exempt'
        db.delete_column('recurring_payments_recurringpayment', 'tax_exempt')
