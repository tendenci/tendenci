...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('campaign_monitor_template', (
            ...
            ('template_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ...
            ('screenshot_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
    ...
    models = {
        ...
        'campaign_monitor.template': {
            ...
            'screenshot_url': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'template_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'update_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
