...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contributions_contribution', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contribution_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contribution_owner', to=orm['auth.User'])),
        ...
        db.send_create_signal('contributions', ['Contribution'])


    def backwards(self, orm):
        
        # Deleting model 'Contribution'
        db.delete_table('contributions_contribution')
    ...
    models = {
        ...
        'contributions.contribution': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contribution_creator'", 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contribution_owner'", 'to': "orm['auth.User']"}),
