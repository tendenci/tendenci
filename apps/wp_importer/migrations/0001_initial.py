...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('wp_importer_blogimport', (
        ...
        db.send_create_signal('wp_importer', ['BlogImport'])

        # Adding model 'AssociatedFile'
        db.create_table('wp_importer_associatedfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('wp_importer', ['AssociatedFile'])


    def backwards(self, orm):
        
        # Deleting model 'BlogImport'
        db.delete_table('wp_importer_blogimport')

        # Deleting model 'AssociatedFile'
        db.delete_table('wp_importer_associatedfile')
