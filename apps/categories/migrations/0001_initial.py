...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('categories_categoryitem', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='categoryitem_category', null=True, to=orm['categories.Category'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='categoryitem_parent', null=True, to=orm['categories.Category'])),
        ))
