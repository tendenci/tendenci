...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('notification_noticeemail', 'bcc', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'NoticeEmail.reply_to'
        db.add_column('notification_noticeemail', 'reply_to', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'NoticeEmail.from_display'
        db.add_column('notification_noticeemail', 'from_display', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NoticeEmail.bcc'
        db.delete_column('notification_noticeemail', 'bcc')

        # Deleting field 'NoticeEmail.reply_to'
        db.delete_column('notification_noticeemail', 'reply_to')

        # Deleting field 'NoticeEmail.from_display'
        db.delete_column('notification_noticeemail', 'from_display')
