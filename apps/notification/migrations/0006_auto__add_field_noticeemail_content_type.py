...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('notification_noticeemail', 'content_type', self.gf('django.db.models.fields.CharField')(default='html', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NoticeEmail.content_type'
        db.delete_column('notification_noticeemail', 'content_type')
