...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('notification_noticeemail', 'sender', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'NoticeEmail.date_sent'
        db.add_column('notification_noticeemail', 'date_sent', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 3, 14, 15, 51, 22, 616739), blank=True), keep_default=False)

        # Changing field 'NoticeEmail.emails'
        db.alter_column('notification_noticeemail', 'emails', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Deleting field 'NoticeEmail.sender'
        db.delete_column('notification_noticeemail', 'sender')

        # Deleting field 'NoticeEmail.date_sent'
        db.delete_column('notification_noticeemail', 'date_sent')

        # Changing field 'NoticeEmail.emails'
        db.alter_column('notification_noticeemail', 'emails', self.gf('django.db.models.fields.TextField')())
