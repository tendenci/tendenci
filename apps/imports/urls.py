...
urlpatterns = patterns('imports.views', 
    ...
    url(r'^users/upload/process/$', 'user_upload_process', name="import.user_upload_process"),
    url(r'^users/upload/subprocess/$', 'user_upload_subprocess', name="import.user_upload_subprocess"),
