...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('case_studies_image', 'file_type', self.gf('django.db.models.fields.CharField')(default='other', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.file_type'
        db.delete_column('case_studies_image', 'file_type')
