...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.program'
        db.add_column('projects_project', 'program', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Program'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.program'
        db.delete_column('projects_project', 'program_id')
