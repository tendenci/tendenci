...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lots_lot', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lot_creator', to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lot_owner', to=orm['auth.User'])),
            ...
            ('map', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lots.Map'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('suite_number', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('hours_open', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        # Adding model 'Photo'
        db.create_table('lots_photo', (
            ('file_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['files.File'], unique=True, primary_key=True)),
            ('lot', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lots.Lot'], unique=True)),
        ))
        db.send_create_signal('lots', ['Photo'])

        # Adding model 'Line'
        db.create_table('lots_line', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lots.Lot'])),
            ('x1', self.gf('django.db.models.fields.FloatField')()),
            ('y1', self.gf('django.db.models.fields.FloatField')()),
            ('x2', self.gf('django.db.models.fields.FloatField')()),
            ('y2', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('lots', ['Line'])


    def backwards(self, orm):
        
        # Deleting model 'Map'
        db.delete_table('lots_map')

        # Deleting model 'Lot'
        db.delete_table('lots_lot')

        # Deleting model 'Photo'
        db.delete_table('lots_photo')

        # Deleting model 'Line'
        db.delete_table('lots_line')
    ...
    models = {
        ...
        'lots.lot': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lot_creator'", 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'hours_open': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'map': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lots.Map']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lot_owner'", 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
            'suite_number': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'tags': ('tagging.fields.TagField', [], {}),
            'update_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'lots.map': {
            'Meta': {'object_name': 'Map', '_ormbases': ['files.File']},
