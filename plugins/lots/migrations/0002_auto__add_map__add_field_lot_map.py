...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lot.map'
        db.add_column('lots_lot', 'map', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['lots.Map']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Lot.map'
        db.delete_column('lots_lot', 'map_id')
