...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.attorney'
        db.add_column('attorneys_photo', 'attorney', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['attorneys.Attorney']), keep_default=False)

        # Deleting field 'Attorney.photo'
        db.delete_column('attorneys_attorney', 'photo_id')


    def backwards(self, orm):
        
        # Deleting field 'Photo.attorney'
        db.delete_column('attorneys_photo', 'attorney_id')

        # Adding field 'Attorney.photo'
        db.add_column('attorneys_attorney', 'photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attorneys.Photo'], null=True, blank=True), keep_default=False)
