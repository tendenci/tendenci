...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attorney.ordering'
        db.add_column('attorneys_attorney', 'ordering', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Attorney.ordering'
        db.delete_column('attorneys_attorney', 'ordering')
