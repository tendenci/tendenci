...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.category_id_num'
        db.delete_column('products_product', 'category_id_num')

        # Adding field 'Product.category_num'
        db.add_column('products_product', 'category_num', self.gf('django.db.models.fields.CharField')(default='1', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Product.category_id_num'
        db.add_column('products_product', 'category_id_num', self.gf('django.db.models.fields.CharField')(default='1', max_length=200), keep_default=False)

        # Deleting field 'Product.category_num'
        db.delete_column('products_product', 'category_num')
    ...
    models = {
        ...
        'products.product': {
            ...
            'msds_label': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            ...
            'product_specs': ('django.db.models.fields.TextField', [], {}),
            'state_registered': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status_detail': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '50'}),
