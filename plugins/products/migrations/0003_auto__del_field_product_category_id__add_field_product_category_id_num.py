...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('products_product', 'category_id', self.gf('django.db.models.fields.CharField')(default='1', max_length=200), keep_default=False)
    ...
    models = {
        ...
        'products.product': {
            ...
            'category_id_num': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
