...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ArchitectureProject', fields ['slug']
        db.create_unique('architecture_projects_architectureproject', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ArchitectureProject', fields ['slug']
        db.delete_unique('architecture_projects_architectureproject', ['slug'])
