...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseAttempt.score'
        db.alter_column('courses_courseattempt', 'score', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'Course.passing_score'
        db.alter_column('courses_course', 'passing_score', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'CourseAttempt.score'
        db.alter_column('courses_courseattempt', 'score', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Course.passing_score'
        db.alter_column('courses_course', 'passing_score', self.gf('django.db.models.fields.IntegerField')())
