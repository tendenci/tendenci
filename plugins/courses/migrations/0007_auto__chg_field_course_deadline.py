...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.deadline'
        db.alter_column('courses_course', 'deadline', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Course.deadline'
        db.alter_column('courses_course', 'deadline', self.gf('django.db.models.fields.DateTimeField')())
