...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.recipients'
        db.add_column('courses_course', 'recipients', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Course.can_retry'
        db.add_column('courses_course', 'can_retry', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.recipients'
        db.delete_column('courses_course', 'recipients')

        # Deleting field 'Course.can_retry'
        db.delete_column('courses_course', 'can_retry')
    ...
    models = {
        ...
        'courses.answer': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'answers'", 'to': "orm['courses.Question']"})
        },
        'courses.course': {
            ...
            'can_retry': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'recipients': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
