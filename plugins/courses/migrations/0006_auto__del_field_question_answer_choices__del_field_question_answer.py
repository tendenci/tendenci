...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Question.answer_choices'
        db.delete_column('courses_question', 'answer_choices')

        # Deleting field 'Question.answer'
        db.delete_column('courses_question', 'answer')


    def backwards(self, orm):
        
        # Adding field 'Question.answer_choices'
        db.add_column('courses_question', 'answer_choices', self.gf('django.db.models.fields.CharField')(default='choice', max_length=200), keep_default=False)

        # Adding field 'Question.answer'
        db.add_column('courses_question', 'answer', self.gf('django.db.models.fields.CharField')(default='answer', max_length=200), keep_default=False)
    ...
    models = {
        ...
        'courses.course': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 9, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
