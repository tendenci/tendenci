...
def index(request, cat_slug=None, template_name="video/list.html"):
    query = cat_slug
...
def search(request, cat_slug=None, template_name="video/list.html"):
...
def details(request, slug, template_name="video/details.html"):
    ...
    if has_perm(request.user, 'video.view_video', video):
        log_defaults = {
            'event_id' : 1200500,
