...
urlpatterns = patterns('tenents.views',
    ...
    url(r'^maps/tenents/kinds/$', 'tenents_kinds', name="tenents.kind"),
    url(r'^maps/tenents/kinds/(?P<pk>[\d/]+)/$', 'tenents_kinds', name="tenents.kinds"),
    url(r'^maps/tenents/kinds/add/(?P<pk>[\d/]+)/$', 'tenents_kinds_add', name="tenents.kinds.add"),
    url(r'^maps/tenents/kinds/edit/(?P<pk>[\d/]+)/$', 'tenents_kinds_edit', name="tenents.kinds.edit"),
    url(r'^maps/tenents/kinds/delete/(?P<pk>[\d/]+)/$', 'tenents_kind_delete', name="tenents.kinds.delete"),
